...
import AccountStatsStat from './AccountStatsStat';
...
class AccountStats {
    /**
     * Constructs a new <code>AccountStats</code>.
     * @alias module:sendpost/model/AccountStats
     */
    constructor() { 
        
        AccountStats.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AccountStats</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:sendpost/model/AccountStats} obj Optional instance to populate.
     * @return {module:sendpost/model/AccountStats} The populated <code>AccountStats</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AccountStats();

            if (data.hasOwnProperty('date')) {
                obj['date'] = ApiClient.convertToType(data['date'], 'Date');
            }
            if (data.hasOwnProperty('stat')) {
                obj['stat'] = AccountStatsStat.constructFromObject(data['stat']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>AccountStats</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AccountStats</code>.
     */
    static validateJSON(data) {
        // validate the optional field `stat`
        if (data['stat']) { // data not null
          AccountStatsStat.validateJSON(data['stat']);
        }
...
/**
     * @return {module:sendpost/model/AccountStatsStat}
     */
    getStat() {
        return this.stat;
    }
    ...
    /**
     * @param {module:sendpost/model/AccountStatsStat} stat
     */
    setStat(stat) {
        this['stat'] = stat;
    }
 ...
 * @member {Date} date
 */
AccountStats.prototype['date'] = undefined;

/**
 * @member {module:sendpost/model/AccountStatsStat} stat
 */
AccountStats.prototype['stat'] = undefined;
