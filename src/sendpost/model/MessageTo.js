...
/**
 * The MessageTo model module.
 * @module sendpost/model/MessageTo
 * @version 2.0.1
 */
class MessageTo {
    /**
     * Constructs a new <code>MessageTo</code>.
     * Recipient object comprising name, email, cc, bcc and customFields
     * @alias module:sendpost/model/MessageTo
     */
    constructor() { 
        
        MessageTo.initialize(this);
    }
    ...
    /**
     * Constructs a <code>MessageTo</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:sendpost/model/MessageTo} obj Optional instance to populate.
     * @return {module:sendpost/model/MessageTo} The populated <code>MessageTo</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MessageTo();
    ...
    /**
     * Validates the JSON data with respect to <code>MessageTo</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MessageTo</code>.
     */
 ...
 * @member {String} name
 */
MessageTo.prototype['name'] = undefined;

/**
 * Email address of the recipient.
 * @member {String} email
 */
MessageTo.prototype['email'] = undefined;

/**
 * List of CC recipients
 * @member {Array.<String>} cc
 */
MessageTo.prototype['cc'] = undefined;

/**
 * List of BCC recipients
 * @member {Array.<String>} bcc
 */
MessageTo.prototype['bcc'] = undefined;

/**
 * Key-Value pair of custom fields.
 * @member {Object.<String, String>} customFields
 */
MessageTo.prototype['customFields'] = undefined;
