...
class Stat {
     ...
     * @alias module:sendpost/model/Stat
     */
    constructor() { 
     ...
     * @param {module:sendpost/model/Stat} obj Optional instance to populate.
     * @return {module:sendpost/model/Stat} The populated <code>Stat</code> instance.
     */
...
/**
     * Returns Date for which stats are retrieved (UTC).
     * @return {Date}
     */
    getDate() {
        return this.date;
    ...
    /**
     * Sets Date for which stats are retrieved (UTC).
     * @param {Date} date Date for which stats are retrieved (UTC).
     */
    setDate(date) {
        this['date'] = date;
    }
