...
/**
     * Returns The ID of the suppression
     * @return {Number}
     */
    getId() {
        return this.id;
    ...
    /**
     * Sets The ID of the suppression
     * @param {Number} id The ID of the suppression
     */
    setId(id) {
        this['id'] = id;
    }
/**
     * Returns The reason for the suppression (0 = manual, 1 = unsubscribe, 2 = hard bounce, 3 = spam complaint)
     * @return {Number}
     */
    getReason() {
        return this.reason;
    ...
    /**
     * Sets The reason for the suppression (0 = manual, 1 = unsubscribe, 2 = hard bounce, 3 = spam complaint)
     * @param {Number} reason The reason for the suppression (0 = manual, 1 = unsubscribe, 2 = hard bounce, 3 = spam complaint)
     */
    setReason(reason) {
        this['reason'] = reason;
    }
/**
     * Returns SMTP error code in case of hard bounce suppression
     * @return {String}
     */
    getSmtpError() {
    ...
    /**
     * Sets SMTP error code in case of hard bounce suppression
     * @param {String} smtpError SMTP error code in case of hard bounce suppression
     */
    setSmtpError(smtpError) {
        this['smtp_error'] = smtpError;
    }
/**
     * Returns The email address for the suppression
     * @return {String}
     */
    getEmail() {
        return this.email;
    ...
    /**
     * Sets The email address for the suppression
     * @param {String} email The email address for the suppression
     */
    setEmail(email) {
        this['email'] = email;
    }
/**
     * Returns UNIX epoch nano timestamp when the suppression was created
     * @return {Number}
     */
    getCreated() {
        return this.created;
    ...
    /**
     * Sets UNIX epoch nano timestamp when the suppression was created
     * @param {Number} created UNIX epoch nano timestamp when the suppression was created
     */
    setCreated(created) {
