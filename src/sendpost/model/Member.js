 ...
 * @module sendpost/model/Member
 * @version 2.0.1
 */
class Member {
    /**
     * Constructs a new <code>Member</code>.
     * @alias module:sendpost/model/Member
     */
    constructor() { 
     ...
     * @param {module:sendpost/model/Member} obj Optional instance to populate.
     * @return {module:sendpost/model/Member} The populated <code>Member</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('notesColor')) {
                obj['notesColor'] = ApiClient.convertToType(data['notesColor'], 'String');
            }
    ...
    static validateJSON(data) {
        ...
        if (data['firebaseUID'] && !(typeof data['firebaseUID'] === 'string' || data['firebaseUID'] instanceof String)) {
            throw new Error("Expected the field `firebaseUID` to be a primitive type in the JSON string but got " + data['firebaseUID']);
        }
        // ensure the json data is a string
        ...
        // ensure the json data is a string
        if (data['notesColor'] && !(typeof data['notesColor'] === 'string' || data['notesColor'] instanceof String)) {
            throw new Error("Expected the field `notesColor` to be a primitive type in the JSON string but got " + data['notesColor']);
        }
...
/**
     * Returns Unique ID for the member
     * @return {Number}
     */
    getId() {
        return this.id;
    ...
    /**
     * Sets Unique ID for the member
     * @param {Number} id Unique ID for the member
     */
    setId(id) {
        this['id'] = id;
    }
/**
     * Returns Indicates whether the member is verified
     * @return {Boolean}
     */
    getIsVerified() {
    ...
    /**
     * Sets Indicates whether the member is verified
     * @param {Boolean} isVerified Indicates whether the member is verified
     */
    setIsVerified(isVerified) {
        this['isVerified'] = isVerified;
    }
/**
     * Returns Indicates whether the member is forbidden
     * @return {Boolean}
     */
    getIsForbidden() {
    ...
    /**
     * Sets Indicates whether the member is forbidden
     * @param {Boolean} isForbidden Indicates whether the member is forbidden
     */
    setIsForbidden(isForbidden) {
        this['isForbidden'] = isForbidden;
    }
/**
     * Returns Firebase UID for the member
     * @return {String}
     */
    getFirebaseUID() {
    ...
    /**
     * Sets Firebase UID for the member
     * @param {String} firebaseUID Firebase UID for the member
     */
    setFirebaseUID(firebaseUID) {
        this['firebaseUID'] = firebaseUID;
    }
/**
     * Returns Email for the member
     * @return {String}
     */
    getEmail() {
        return this.email;
    ...
    /**
     * Sets Email for the member
     * @param {String} email Email for the member
     */
    setEmail(email) {
        this['email'] = email;
    }
/**
     * Returns Name for the member
     * @return {String}
     */
    getName() {
        return this.name;
    ...
    /**
     * Sets Name for the member
     * @param {String} name Name for the member
     */
    setName(name) {
        this['name'] = name;
    }
/**
     * Returns Logo URL for the member
     * @return {String}
     */
    getUrl() {
        return this.url;
    ...
    /**
     * Sets Logo URL for the member
     * @param {String} url Logo URL for the member
     */
    setUrl(url) {
        this['url'] = url;
    }
/**
     * Returns Company name for the member
     * @return {String}
     */
    getCompanyName() {
    ...
    /**
     * Sets Company name for the member
     * @param {String} companyName Company name for the member
     */
    setCompanyName(companyName) {
        this['companyName'] = companyName;
    }
/**
     * Returns Indicates whether the member has answered onboarding question
     * @return {Boolean}
     */
    getOnboardQAnswered() {
        return this.onboardQAnswered;
    }

    /**
     * Sets Indicates whether the member has answered onboarding question
     * @param {Boolean} onboardQAnswered Indicates whether the member has answered onboarding question
     */
    setOnboardQAnswered(onboardQAnswered) {
        this['onboardQAnswered'] = onboardQAnswered;
    }
/**
     * Returns Phone number for the member
     * @return {String}
     */
    getPhoneNumber() {
    ...
    /**
     * Sets Phone number for the member
     * @param {String} phoneNumber Phone number for the member
     */
    setPhoneNumber(phoneNumber) {
        this['phoneNumber'] = phoneNumber;
    }
/**
     * Returns Color for the member's notes
     * @return {String}
     */
    getNotesColor() {
    ...
    /**
     * Sets Color for the member's notes
     * @param {String} notesColor Color for the member's notes
     */
    setNotesColor(notesColor) {
        this['notesColor'] = notesColor;
    }
/**
     * Returns UNIX epoch nano timestamp when the member was created
     * @return {Number}
     */
    getCreated() {
        return this.created;
    ...
    /**
     * Sets UNIX epoch nano timestamp when the member was created
     * @param {Number} created UNIX epoch nano timestamp when the member was created
     */
    setCreated(created) {
 ...
 * @member {String} notesColor
 */
Member.prototype['notesColor'] = undefined;
