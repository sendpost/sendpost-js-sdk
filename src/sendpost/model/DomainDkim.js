...
/**
 * The DomainDkim model module.
 * @module sendpost/model/DomainDkim
 * @version 2.0.1
 */
class DomainDkim {
    /**
     * Constructs a new <code>DomainDkim</code>.
     * DKIM record host, type and value
     * @alias module:sendpost/model/DomainDkim
     */
    constructor() { 
        
        DomainDkim.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DomainDkim</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:sendpost/model/DomainDkim} obj Optional instance to populate.
     * @return {module:sendpost/model/DomainDkim} The populated <code>DomainDkim</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DomainDkim();
    ...
    /**
     * Validates the JSON data with respect to <code>DomainDkim</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DomainDkim</code>.
     */
 ...
 * @member {String} host
 */
DomainDkim.prototype['host'] = undefined;

/**
 * @member {String} type
 */
DomainDkim.prototype['type'] = undefined;

/**
 * @member {String} textValue
 */
DomainDkim.prototype['textValue'] = undefined;
