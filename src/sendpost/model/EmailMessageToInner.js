...
import EmailMessageToInnerBccInner from './EmailMessageToInnerBccInner';
import EmailMessageToInnerCcInner from './EmailMessageToInnerCcInner';

/**
 * The EmailMessageToInner model module.
 * @module sendpost/model/EmailMessageToInner
 * @version 1.0.0
 */
class EmailMessageToInner {
    /**
     * Constructs a new <code>EmailMessageToInner</code>.
     * @alias module:sendpost/model/EmailMessageToInner
     */
    constructor() { 
        
        EmailMessageToInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>EmailMessageToInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:sendpost/model/EmailMessageToInner} obj Optional instance to populate.
     * @return {module:sendpost/model/EmailMessageToInner} The populated <code>EmailMessageToInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EmailMessageToInner();
            ...
            if (data.hasOwnProperty('cc')) {
                obj['cc'] = ApiClient.convertToType(data['cc'], [EmailMessageToInnerCcInner]);
            }
            if (data.hasOwnProperty('bcc')) {
                obj['bcc'] = ApiClient.convertToType(data['bcc'], [EmailMessageToInnerBccInner]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>EmailMessageToInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EmailMessageToInner</code>.
     */
    static validateJSON(data) {
        ...
        if (data['cc']) { // data not null
            ...
            for (const item of data['cc']) {
                EmailMessageToInnerCcInner.validateJSON(item);
            };
        }
        if (data['bcc']) { // data not null
            ...
            for (const item of data['bcc']) {
                EmailMessageToInnerBccInner.validateJSON(item);
            };
        }
...
/**
     * @return {Array.<module:sendpost/model/EmailMessageToInnerCcInner>}
     */
    getCc() {
        return this.cc;
    }
    ...
    /**
     * @param {Array.<module:sendpost/model/EmailMessageToInnerCcInner>} cc
     */
    setCc(cc) {
        this['cc'] = cc;
    }
/**
     * @return {Array.<module:sendpost/model/EmailMessageToInnerBccInner>}
     */
    getBcc() {
        return this.bcc;
    }
    ...
    /**
     * @param {Array.<module:sendpost/model/EmailMessageToInnerBccInner>} bcc
     */
    setBcc(bcc) {
        this['bcc'] = bcc;
    }
 ...
 * @member {String} name
 */
EmailMessageToInner.prototype['name'] = undefined;

/**
 * @member {String} email
 */
EmailMessageToInner.prototype['email'] = undefined;

/**
 * @member {Object.<String, String>} customFields
 */
EmailMessageToInner.prototype['customFields'] = undefined;

/**
 * @member {Array.<module:sendpost/model/EmailMessageToInnerCcInner>} cc
 */
EmailMessageToInner.prototype['cc'] = undefined;

/**
 * @member {Array.<module:sendpost/model/EmailMessageToInnerBccInner>} bcc
 */
EmailMessageToInner.prototype['bcc'] = undefined;
...
export default EmailMessageToInner;
