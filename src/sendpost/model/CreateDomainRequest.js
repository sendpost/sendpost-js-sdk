 ...
 * @module sendpost/model/CreateDomainRequest
 * @version 2.0.1
 */
class CreateDomainRequest {
    /**
     * Constructs a new <code>CreateDomainRequest</code>.
     * @alias module:sendpost/model/CreateDomainRequest
     */
    constructor() { 
     ...
     * @param {module:sendpost/model/CreateDomainRequest} obj Optional instance to populate.
     * @return {module:sendpost/model/CreateDomainRequest} The populated <code>CreateDomainRequest</code> instance.
     */
...
/**
     * Returns Name of the domain (e.g., hooli.com).
     * @return {String}
     */
    getName() {
        return this.name;
    ...
    /**
     * Sets Name of the domain (e.g., hooli.com).
     * @param {String} name Name of the domain (e.g., hooli.com).
     */
    setName(name) {
        this['name'] = name;
    }
