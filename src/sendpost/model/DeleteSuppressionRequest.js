...
class DeleteSuppressionRequest {
    /**
     * Constructs a new <code>DeleteSuppressionRequest</code>.
     * @alias module:sendpost/model/DeleteSuppressionRequest
     */
    constructor() { 
        
        DeleteSuppressionRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DeleteSuppressionRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:sendpost/model/DeleteSuppressionRequest} obj Optional instance to populate.
     * @return {module:sendpost/model/DeleteSuppressionRequest} The populated <code>DeleteSuppressionRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteSuppressionRequest();

            if (data.hasOwnProperty('suppressions')) {
                obj['suppressions'] = ApiClient.convertToType(data['suppressions'], [CreateSuppressionRequestSpamComplaintInner]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteSuppressionRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteSuppressionRequest</code>.
     */
...
/**
    ...
    /**
     * @param {Array.<module:sendpost/model/CreateSuppressionRequestSpamComplaintInner>} suppressions
     */
...
/**
 * @member {Array.<module:sendpost/model/CreateSuppressionRequestSpamComplaintInner>} suppressions
 */
DeleteSuppressionRequest.prototype['suppressions'] = undefined;
...
export default DeleteSuppressionRequest;
