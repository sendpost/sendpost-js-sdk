...
class SMTPAuth {
    /**
     * Constructs a new <code>SMTPAuth</code>.
     * @alias module:sendpost/model/SMTPAuth
     */
    constructor() { 
        
        SMTPAuth.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SMTPAuth</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:sendpost/model/SMTPAuth} obj Optional instance to populate.
     * @return {module:sendpost/model/SMTPAuth} The populated <code>SMTPAuth</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SMTPAuth();
    ...
    /**
     * Validates the JSON data with respect to <code>SMTPAuth</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SMTPAuth</code>.
     */
...
/**
     * Returns Unique ID for the SMTP Auth
     * @return {Number}
     */
    getId() {
        return this.id;
    ...
    /**
     * Sets Unique ID for the SMTP Auth
     * @param {Number} id Unique ID for the SMTP Auth
     */
    setId(id) {
        this['id'] = id;
    }
/**
     * Returns Username for the SMTP Auth
     * @return {String}
     */
    getUsername() {
    ...
    /**
     * Sets Username for the SMTP Auth
     * @param {String} username Username for the SMTP Auth
     */
    setUsername(username) {
        this['username'] = username;
    }
/**
     * Returns Password for the SMTP Auth
     * @return {String}
     */
    getPassword() {
    ...
    /**
     * Sets Password for the SMTP Auth
     * @param {String} password Password for the SMTP Auth
     */
    setPassword(password) {
        this['password'] = password;
    }
/**
     * Returns UNIX epoch nano timestamp when the SMTP Auth was created
     * @return {Number}
     */
    getCreated() {
        return this.created;
    ...
    /**
     * Sets UNIX epoch nano timestamp when the SMTP Auth was created
     * @param {Number} created UNIX epoch nano timestamp when the SMTP Auth was created
     */
    setCreated(created) {
        this['created'] = created;
    }
/**
     * Returns UNIX epoch nano timestamp when the SMTP Auth was updated
     * @return {Number}
     */
    getUpdated() {
        return this.updated;
    ...
    /**
     * Sets UNIX epoch nano timestamp when the SMTP Auth was updated
     * @param {Number} updated UNIX epoch nano timestamp when the SMTP Auth was updated
     */
    setUpdated(updated) {
