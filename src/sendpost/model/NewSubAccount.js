...
/**
 * The NewSubAccount model module.
 * @module sendpost/model/NewSubAccount
 * @version 1.0.0
 */
class NewSubAccount {
    /**
     * Constructs a new <code>NewSubAccount</code>.
     * @alias module:sendpost/model/NewSubAccount
     */
    constructor() { 
        
        NewSubAccount.initialize(this);
    }
    ...
    /**
     * Constructs a <code>NewSubAccount</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:sendpost/model/NewSubAccount} obj Optional instance to populate.
     * @return {module:sendpost/model/NewSubAccount} The populated <code>NewSubAccount</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new NewSubAccount();
    ...
    /**
     * Validates the JSON data with respect to <code>NewSubAccount</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>NewSubAccount</code>.
     */
 ...
 * @member {String} name
 */
NewSubAccount.prototype['name'] = undefined;
