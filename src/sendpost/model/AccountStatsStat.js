...
class AccountStatsStat {
    /**
     * Constructs a new <code>AccountStatsStat</code>.
     * @alias module:sendpost/model/AccountStatsStat
     */
    constructor() { 
        
        AccountStatsStat.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AccountStatsStat</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:sendpost/model/AccountStatsStat} obj Optional instance to populate.
     * @return {module:sendpost/model/AccountStatsStat} The populated <code>AccountStatsStat</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AccountStatsStat();
    ...
    /**
     * Validates the JSON data with respect to <code>AccountStatsStat</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AccountStatsStat</code>.
     */
 ...
 */
AccountStatsStat.prototype['hardBounced'] = undefined;
...
export default AccountStatsStat;
