 ...
 * @module sendpost/model/NewWebhook
 * @version 1.0.0
 */
class NewWebhook {
    /**
     * Constructs a new <code>NewWebhook</code>.
     * @alias module:sendpost/model/NewWebhook
     */
    constructor() { 
     ...
     * @param {module:sendpost/model/NewWebhook} obj Optional instance to populate.
     * @return {module:sendpost/model/NewWebhook} The populated <code>NewWebhook</code> instance.
     */
    ...
    /**
     * Validates the JSON data with respect to <code>NewWebhook</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>NewWebhook</code>.
     */
