...
/**
 * The StatStats model module.
 * @module sendpost/model/StatStats
 * @version 1.0.0
 */
class StatStats {
    /**
     * Constructs a new <code>StatStats</code>.
     * @alias module:sendpost/model/StatStats
     */
    constructor() { 
        
        StatStats.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StatStats</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:sendpost/model/StatStats} obj Optional instance to populate.
     * @return {module:sendpost/model/StatStats} The populated <code>StatStats</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StatStats();
    ...
    /**
     * Validates the JSON data with respect to <code>StatStats</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StatStats</code>.
     */
