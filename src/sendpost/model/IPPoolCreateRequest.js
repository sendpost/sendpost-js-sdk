...
class IPPoolCreateRequest {
    /**
     * Constructs a new <code>IPPoolCreateRequest</code>.
     * @alias module:sendpost/model/IPPoolCreateRequest
     */
    constructor() { 
        
        IPPoolCreateRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>IPPoolCreateRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:sendpost/model/IPPoolCreateRequest} obj Optional instance to populate.
     * @return {module:sendpost/model/IPPoolCreateRequest} The populated <code>IPPoolCreateRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new IPPoolCreateRequest();

            if (data.hasOwnProperty('name')) {
                obj['name'] = ApiClient.convertToType(data['name'], 'String');
            }
            if (data.hasOwnProperty('ips')) {
                obj['ips'] = ApiClient.convertToType(data['ips'], [EIP]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>IPPoolCreateRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>IPPoolCreateRequest</code>.
     */
...
/**
     * @return {Array.<module:sendpost/model/EIP>}
     */
    getIps() {
        return this.ips;
    }
    ...
    /**
     * @param {Array.<module:sendpost/model/EIP>} ips
     */
    setIps(ips) {
        this['ips'] = ips;
    }
 ...
 * @member {String} name
 */
IPPoolCreateRequest.prototype['name'] = undefined;

/**
 * @member {Array.<module:sendpost/model/EIP>} ips
 */
IPPoolCreateRequest.prototype['ips'] = undefined;

/**
 * @member {Array.<Number>} tpsps
 */
IPPoolCreateRequest.prototype['tpsps'] = undefined;

/**
 * @member {Number} routingStrategy
 */
IPPoolCreateRequest.prototype['routingStrategy'] = undefined;

/**
 * @member {String} routingMetaData
 */
IPPoolCreateRequest.prototype['routingMetaData'] = undefined;
...
export default IPPoolCreateRequest;
