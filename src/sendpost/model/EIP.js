...
/**
 * The EIP model module.
 * @module sendpost/model/EIP
 * @version 2.0.1
 */
class EIP {
    /**
     * Constructs a new <code>EIP</code>.
     * @alias module:sendpost/model/EIP
     * @param publicIP {String} list of IP resources which are a part of the IP Pool containing public IP information. Note that the IPs specified in the IPPool should have been allocated in advance for your account
     */
    constructor(publicIP) { 
        
        EIP.initialize(this, publicIP);
    }
    ...
    /**
     * Constructs a <code>EIP</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:sendpost/model/EIP} obj Optional instance to populate.
     * @return {module:sendpost/model/EIP} The populated <code>EIP</code> instance.
     */
    ...
    /**
     * Validates the JSON data with respect to <code>EIP</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EIP</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EIP.RequiredProperties) {
...
/**
     * Returns list of IP resources which are a part of the IP Pool containing public IP information. Note that the IPs specified in the IPPool should have been allocated in advance for your account
     * @return {String}
     */
    getPublicIP() {
    ...
    /**
     * Sets list of IP resources which are a part of the IP Pool containing public IP information. Note that the IPs specified in the IPPool should have been allocated in advance for your account
     * @param {String} publicIP list of IP resources which are a part of the IP Pool containing public IP information. Note that the IPs specified in the IPPool should have been allocated in advance for your account
     */
...
EIP.RequiredProperties = ["publicIP"];
 ...
 */
EIP.prototype['publicIP'] = undefined;
