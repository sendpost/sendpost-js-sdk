...
/**
 * The EmailMessageReplyTo model module.
 * @module sendpost/model/EmailMessageReplyTo
 * @version 2.0.1
 */
class EmailMessageReplyTo {
    /**
     * Constructs a new <code>EmailMessageReplyTo</code>.
     * @alias module:sendpost/model/EmailMessageReplyTo
     */
    constructor() { 
        
        EmailMessageReplyTo.initialize(this);
    }
    ...
    /**
     * Constructs a <code>EmailMessageReplyTo</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:sendpost/model/EmailMessageReplyTo} obj Optional instance to populate.
     * @return {module:sendpost/model/EmailMessageReplyTo} The populated <code>EmailMessageReplyTo</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EmailMessageReplyTo();
    ...
    /**
     * Validates the JSON data with respect to <code>EmailMessageReplyTo</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EmailMessageReplyTo</code>.
     */
 ...
 * @member {String} name
 */
EmailMessageReplyTo.prototype['name'] = undefined;

/**
 * @member {String} email
 */
EmailMessageReplyTo.prototype['email'] = undefined;
...
export default EmailMessageReplyTo;
