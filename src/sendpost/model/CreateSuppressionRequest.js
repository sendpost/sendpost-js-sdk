...
import CreateSuppressionRequestHardBounceInner from './CreateSuppressionRequestHardBounceInner';
import CreateSuppressionRequestManualInner from './CreateSuppressionRequestManualInner';
import CreateSuppressionRequestSpamComplaintInner from './CreateSuppressionRequestSpamComplaintInner';
import CreateSuppressionRequestUnsubscribeInner from './CreateSuppressionRequestUnsubscribeInner';
...
class CreateSuppressionRequest {
    /**
     * Constructs a new <code>CreateSuppressionRequest</code>.
     * @alias module:sendpost/model/CreateSuppressionRequest
     */
    constructor() { 
        
        CreateSuppressionRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateSuppressionRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:sendpost/model/CreateSuppressionRequest} obj Optional instance to populate.
     * @return {module:sendpost/model/CreateSuppressionRequest} The populated <code>CreateSuppressionRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateSuppressionRequest();

            if (data.hasOwnProperty('hardBounce')) {
                obj['hardBounce'] = ApiClient.convertToType(data['hardBounce'], [CreateSuppressionRequestHardBounceInner]);
            }
            if (data.hasOwnProperty('manual')) {
                obj['manual'] = ApiClient.convertToType(data['manual'], [CreateSuppressionRequestManualInner]);
            }
            if (data.hasOwnProperty('unsubscribe')) {
                obj['unsubscribe'] = ApiClient.convertToType(data['unsubscribe'], [CreateSuppressionRequestUnsubscribeInner]);
            }
            if (data.hasOwnProperty('spamComplaint')) {
                obj['spamComplaint'] = ApiClient.convertToType(data['spamComplaint'], [CreateSuppressionRequestSpamComplaintInner]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateSuppressionRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateSuppressionRequest</code>.
     */
    static validateJSON(data) {
        if (data['hardBounce']) { // data not null
            ...
            for (const item of data['hardBounce']) {
                CreateSuppressionRequestHardBounceInner.validateJSON(item);
            };
        }
        if (data['manual']) { // data not null
            ...
            for (const item of data['manual']) {
                CreateSuppressionRequestManualInner.validateJSON(item);
            };
        }
        if (data['unsubscribe']) { // data not null
            ...
            for (const item of data['unsubscribe']) {
                CreateSuppressionRequestUnsubscribeInner.validateJSON(item);
            };
        }
        if (data['spamComplaint']) { // data not null
            ...
            for (const item of data['spamComplaint']) {
                CreateSuppressionRequestSpamComplaintInner.validateJSON(item);
            };
        }
...
/**
     * Returns list of email addresses which you want to mark in hardBounce suppression list
     * @return {Array.<module:sendpost/model/CreateSuppressionRequestHardBounceInner>}
     */
    getHardBounce() {
    ...
    /**
     * Sets list of email addresses which you want to mark in hardBounce suppression list
     * @param {Array.<module:sendpost/model/CreateSuppressionRequestHardBounceInner>} hardBounce list of email addresses which you want to mark in hardBounce suppression list
     */
    setHardBounce(hardBounce) {
        this['hardBounce'] = hardBounce;
    }
/**
     * Returns list of email addresses which you want to mark in manual suppression list
     * @return {Array.<module:sendpost/model/CreateSuppressionRequestManualInner>}
     */
    getManual() {
        return this.manual;
    }
    ...
    /**
     * Sets list of email addresses which you want to mark in manual suppression list
     * @param {Array.<module:sendpost/model/CreateSuppressionRequestManualInner>} manual list of email addresses which you want to mark in manual suppression list
     */
    setManual(manual) {
        this['manual'] = manual;
    }
/**
     * Returns list of email addresses which you want to mark in unsubscribe suppression list
     * @return {Array.<module:sendpost/model/CreateSuppressionRequestUnsubscribeInner>}
     */
    getUnsubscribe() {
    ...
    /**
     * Sets list of email addresses which you want to mark in unsubscribe suppression list
     * @param {Array.<module:sendpost/model/CreateSuppressionRequestUnsubscribeInner>} unsubscribe list of email addresses which you want to mark in unsubscribe suppression list
     */
    setUnsubscribe(unsubscribe) {
        this['unsubscribe'] = unsubscribe;
    }
/**
     * Returns list of email addresses which you want to mark in spamComplaint suppression list
     * @return {Array.<module:sendpost/model/CreateSuppressionRequestSpamComplaintInner>}
     */
    getSpamComplaint() {
    ...
    /**
     * Sets list of email addresses which you want to mark in spamComplaint suppression list
     * @param {Array.<module:sendpost/model/CreateSuppressionRequestSpamComplaintInner>} spamComplaint list of email addresses which you want to mark in spamComplaint suppression list
     */
 ...
 * @member {Array.<module:sendpost/model/CreateSuppressionRequestHardBounceInner>} hardBounce
 */
CreateSuppressionRequest.prototype['hardBounce'] = undefined;

/**
 * list of email addresses which you want to mark in manual suppression list
 * @member {Array.<module:sendpost/model/CreateSuppressionRequestManualInner>} manual
 */
CreateSuppressionRequest.prototype['manual'] = undefined;

/**
 * list of email addresses which you want to mark in unsubscribe suppression list
 * @member {Array.<module:sendpost/model/CreateSuppressionRequestUnsubscribeInner>} unsubscribe
 */
CreateSuppressionRequest.prototype['unsubscribe'] = undefined;

/**
 * list of email addresses which you want to mark in spamComplaint suppression list
 * @member {Array.<module:sendpost/model/CreateSuppressionRequestSpamComplaintInner>} spamComplaint
 */
CreateSuppressionRequest.prototype['spamComplaint'] = undefined;
...
export default CreateSuppressionRequest;
