...
class EmailAddress {
     ...
     * @alias module:sendpost/model/EmailAddress
     */
    constructor() { 
     ...
     * @param {module:sendpost/model/EmailAddress} obj Optional instance to populate.
     * @return {module:sendpost/model/EmailAddress} The populated <code>EmailAddress</code> instance.
     */
 ...
 * @member {String} name
 */
EmailAddress.prototype['name'] = undefined;
