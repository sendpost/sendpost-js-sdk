...
/**
 * The CreateSuppressionRequestManualInner model module.
 * @module sendpost/model/CreateSuppressionRequestManualInner
 * @version 2.0.1
 */
class CreateSuppressionRequestManualInner {
    /**
     * Constructs a new <code>CreateSuppressionRequestManualInner</code>.
     * @alias module:sendpost/model/CreateSuppressionRequestManualInner
     */
    constructor() { 
        
        CreateSuppressionRequestManualInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateSuppressionRequestManualInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:sendpost/model/CreateSuppressionRequestManualInner} obj Optional instance to populate.
     * @return {module:sendpost/model/CreateSuppressionRequestManualInner} The populated <code>CreateSuppressionRequestManualInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateSuppressionRequestManualInner();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateSuppressionRequestManualInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateSuppressionRequestManualInner</code>.
     */
 ...
 * @member {String} email
 */
CreateSuppressionRequestManualInner.prototype['email'] = undefined;
...
export default CreateSuppressionRequestManualInner;
