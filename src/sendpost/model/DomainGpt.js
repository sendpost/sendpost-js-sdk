...
/**
 * The DomainGpt model module.
 * @module sendpost/model/DomainGpt
 * @version 2.0.1
 */
class DomainGpt {
    /**
     * Constructs a new <code>DomainGpt</code>.
     * GPT record host, type and value
     * @alias module:sendpost/model/DomainGpt
     */
    constructor() { 
        
        DomainGpt.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DomainGpt</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:sendpost/model/DomainGpt} obj Optional instance to populate.
     * @return {module:sendpost/model/DomainGpt} The populated <code>DomainGpt</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DomainGpt();
    ...
    /**
     * Validates the JSON data with respect to <code>DomainGpt</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DomainGpt</code>.
     */
 ...
 * @member {String} host
 */
DomainGpt.prototype['host'] = undefined;

/**
 * @member {String} type
 */
DomainGpt.prototype['type'] = undefined;

/**
 * @member {String} textValue
 */
DomainGpt.prototype['textValue'] = undefined;
