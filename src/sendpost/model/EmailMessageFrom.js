...
/**
 * The EmailMessageFrom model module.
 * @module sendpost/model/EmailMessageFrom
 * @version 2.0.1
 */
class EmailMessageFrom {
    /**
     * Constructs a new <code>EmailMessageFrom</code>.
     * @alias module:sendpost/model/EmailMessageFrom
     */
    constructor() { 
        
        EmailMessageFrom.initialize(this);
    }
    ...
    /**
     * Constructs a <code>EmailMessageFrom</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:sendpost/model/EmailMessageFrom} obj Optional instance to populate.
     * @return {module:sendpost/model/EmailMessageFrom} The populated <code>EmailMessageFrom</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EmailMessageFrom();
    ...
    /**
     * Validates the JSON data with respect to <code>EmailMessageFrom</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EmailMessageFrom</code>.
     */
 ...
 * @member {String} name
 */
EmailMessageFrom.prototype['name'] = undefined;

/**
 * @member {String} email
 */
EmailMessageFrom.prototype['email'] = undefined;
...
export default EmailMessageFrom;
