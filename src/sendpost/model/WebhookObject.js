 ...
 * @module sendpost/model/WebhookObject
 * @version 1.0.0
 */
class WebhookObject {
    /**
     * Constructs a new <code>WebhookObject</code>.
     * @alias module:sendpost/model/WebhookObject
     */
    constructor() { 
     ...
     * @param {module:sendpost/model/WebhookObject} obj Optional instance to populate.
     * @return {module:sendpost/model/WebhookObject} The populated <code>WebhookObject</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('emailMessage')) {
                obj['emailMessage'] = EmailMessage.constructFromObject(data['emailMessage']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['emailMessage']) { // data not null
          EmailMessage.validateJSON(data['emailMessage']);
        }
...
/**
     * @return {module:sendpost/model/Event}
     */
    getEvent() {
        return this.event;
    }
    ...
    /**
     * @param {module:sendpost/model/Event} event
     */
    setEvent(event) {
        this['event'] = event;
    }
/**
     * @return {module:sendpost/model/EmailMessage}
     */
    getEmailMessage() {
    ...
    /**
     * @param {module:sendpost/model/EmailMessage} emailMessage
     */
...
/**
 * @member {module:sendpost/model/Event} event
 */
WebhookObject.prototype['event'] = undefined;

/**
 * @member {module:sendpost/model/EmailMessage} emailMessage
 */
WebhookObject.prototype['emailMessage'] = undefined;
