...
/**
 * The IPUpdateRequest model module.
 * @module sendpost/model/IPUpdateRequest
 * @version 1.0.0
 */
class IPUpdateRequest {
    /**
     * Constructs a new <code>IPUpdateRequest</code>.
     * @alias module:sendpost/model/IPUpdateRequest
     * @param autoWarmupEnabled {Boolean} Whether the IP warmup should happen automatically or be managed manually
     */
    constructor(autoWarmupEnabled) { 
        
        IPUpdateRequest.initialize(this, autoWarmupEnabled);
    }
     ...
     */
    static initialize(obj, autoWarmupEnabled) { 
        obj['autoWarmupEnabled'] = autoWarmupEnabled;
    }

    /**
     * Constructs a <code>IPUpdateRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:sendpost/model/IPUpdateRequest} obj Optional instance to populate.
     * @return {module:sendpost/model/IPUpdateRequest} The populated <code>IPUpdateRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new IPUpdateRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>IPUpdateRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>IPUpdateRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of IPUpdateRequest.RequiredProperties) {
...
/**
     * Returns Whether the IP warmup should happen automatically or be managed manually
     * @return {Boolean}
     */
    ...
    /**
     * Sets Whether the IP warmup should happen automatically or be managed manually
     * @param {Boolean} autoWarmupEnabled Whether the IP warmup should happen automatically or be managed manually
     */
...
IPUpdateRequest.RequiredProperties = ["autoWarmupEnabled"];

/**
 * Whether the IP warmup should happen automatically or be managed manually
 * @member {Boolean} autoWarmupEnabled
 */
IPUpdateRequest.prototype['autoWarmupEnabled'] = undefined;
...
export default IPUpdateRequest;
