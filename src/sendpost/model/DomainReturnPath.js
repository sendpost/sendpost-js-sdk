...
/**
 * The DomainReturnPath model module.
 * @module sendpost/model/DomainReturnPath
 * @version 1.0.0
 */
class DomainReturnPath {
    /**
     * Constructs a new <code>DomainReturnPath</code>.
     * ReturnPath record host, type and value
     * @alias module:sendpost/model/DomainReturnPath
     */
    constructor() { 
        
        DomainReturnPath.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DomainReturnPath</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:sendpost/model/DomainReturnPath} obj Optional instance to populate.
     * @return {module:sendpost/model/DomainReturnPath} The populated <code>DomainReturnPath</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DomainReturnPath();
    ...
    /**
     * Validates the JSON data with respect to <code>DomainReturnPath</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DomainReturnPath</code>.
     */
 ...
 * @member {String} host
 */
DomainReturnPath.prototype['host'] = undefined;

/**
 * @member {String} type
 */
DomainReturnPath.prototype['type'] = undefined;

/**
 * @member {String} textValue
 */
DomainReturnPath.prototype['textValue'] = undefined;
...
export default DomainReturnPath;
