...
/**
 * The IPDeletionResponse model module.
 * @module sendpost/model/IPDeletionResponse
 * @version 1.0.0
 */
class IPDeletionResponse {
    /**
     * Constructs a new <code>IPDeletionResponse</code>.
     * @alias module:sendpost/model/IPDeletionResponse
     * @param id {Number} The unique ID of the IP
     * @param message {String} The confirmation message after deletion
     */
    constructor(id, message) { 
        
        IPDeletionResponse.initialize(this, id, message);
    }
    ...
    /**
     * Constructs a <code>IPDeletionResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:sendpost/model/IPDeletionResponse} obj Optional instance to populate.
     * @return {module:sendpost/model/IPDeletionResponse} The populated <code>IPDeletionResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new IPDeletionResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>IPDeletionResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>IPDeletionResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of IPDeletionResponse.RequiredProperties) {
...
/**
     * Returns The unique ID of the IP
     * @return {Number}
     */
    getId() {
        return this.id;
    ...
    /**
     * Sets The unique ID of the IP
     * @param {Number} id The unique ID of the IP
     */
    setId(id) {
        this['id'] = id;
    }
/**
     * Returns The confirmation message after deletion
     * @return {String}
     */
    getMessage() {
        return this.message;
    ...
    /**
     * Sets The confirmation message after deletion
...
IPDeletionResponse.RequiredProperties = ["id", "message"];

/**
 * The unique ID of the IP
 * @member {Number} id
 */
IPDeletionResponse.prototype['id'] = undefined;

/**
 * The confirmation message after deletion
 * @member {String} message
 */
IPDeletionResponse.prototype['message'] = undefined;
...
export default IPDeletionResponse;
