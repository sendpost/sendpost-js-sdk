...
/**
 * The CreateSuppressionRequestHardBounceInner model module.
 * @module sendpost/model/CreateSuppressionRequestHardBounceInner
 * @version 1.0.0
 */
class CreateSuppressionRequestHardBounceInner {
    /**
     * Constructs a new <code>CreateSuppressionRequestHardBounceInner</code>.
     * @alias module:sendpost/model/CreateSuppressionRequestHardBounceInner
     */
    constructor() { 
        
        CreateSuppressionRequestHardBounceInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateSuppressionRequestHardBounceInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:sendpost/model/CreateSuppressionRequestHardBounceInner} obj Optional instance to populate.
     * @return {module:sendpost/model/CreateSuppressionRequestHardBounceInner} The populated <code>CreateSuppressionRequestHardBounceInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateSuppressionRequestHardBounceInner();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateSuppressionRequestHardBounceInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateSuppressionRequestHardBounceInner</code>.
     */
 ...
 * @member {String} email
 */
CreateSuppressionRequestHardBounceInner.prototype['email'] = undefined;
...
export default CreateSuppressionRequestHardBounceInner;
