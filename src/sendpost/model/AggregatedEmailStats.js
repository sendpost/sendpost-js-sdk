...
/**
 * The AggregatedEmailStats model module.
 * @module sendpost/model/AggregatedEmailStats
 * @version 1.0.0
 */
class AggregatedEmailStats {
    /**
     * Constructs a new <code>AggregatedEmailStats</code>.
     * @alias module:sendpost/model/AggregatedEmailStats
     */
    constructor() { 
        
        AggregatedEmailStats.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AggregatedEmailStats</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:sendpost/model/AggregatedEmailStats} obj Optional instance to populate.
     * @return {module:sendpost/model/AggregatedEmailStats} The populated <code>AggregatedEmailStats</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AggregatedEmailStats();
    ...
    /**
     * Validates the JSON data with respect to <code>AggregatedEmailStats</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AggregatedEmailStats</code>.
     */
...
/**
     * Returns Total number of emails accepted by SendPost API
     * @return {Number}
     */
    getProcessed() {
    ...
    /**
     * Sets Total number of emails accepted by SendPost API
     * @param {Number} processed Total number of emails accepted by SendPost API
     */
...
/**
    ...
    /**
     * Sets Total number of emails successfully delivered to SMTP
     * @param {Number} delivered Total number of emails successfully delivered to SMTP
     */
    setDelivered(delivered) {
        this['delivered'] = delivered;
    }
/**
     * Returns Total number of emails dropped without delivery
     * @return {Number}
     */
    getDropped() {
        return this.dropped;
    ...
    /**
     * Sets Total number of emails dropped without delivery
     * @param {Number} dropped Total number of emails dropped without delivery
     */
    setDropped(dropped) {
...
/**
    ...
    /**
     * Sets Total number of hard bounce errors
     * @param {Number} hardBounced Total number of hard bounce errors
     */
    setHardBounced(hardBounced) {
        this['hardBounced'] = hardBounced;
    }
/**
     * Returns Total number of soft bounce errors
     * @return {Number}
     */
    getSoftBounced() {
    ...
    /**
     * Sets Total number of soft bounce errors
     * @param {Number} softBounced Total number of soft bounce errors
     */
    setSoftBounced(softBounced) {
        this['softBounced'] = softBounced;
    }
/**
     * Returns Total number of emails opened by recipients
     * @return {Number}
     */
    getOpened() {
        return this.opened;
    ...
    /**
     * Sets Total number of emails opened by recipients
     * @param {Number} opened Total number of emails opened by recipients
     */
    setOpened(opened) {
        this['opened'] = opened;
    }
/**
     * Returns Total number of links clicked by recipients
     * @return {Number}
     */
    getClicked() {
        return this.clicked;
    ...
    /**
     * Sets Total number of links clicked by recipients
     * @param {Number} clicked Total number of links clicked by recipients
     */
    setClicked(clicked) {
        this['clicked'] = clicked;
    }
/**
     * Returns Total number of unsubscribed recipients
     * @return {Number}
     */
    getUnsubscribed() {
    ...
    /**
     * Sets Total number of unsubscribed recipients
     * @param {Number} unsubscribed Total number of unsubscribed recipients
     */
    setUnsubscribed(unsubscribed) {
        this['unsubscribed'] = unsubscribed;
    }
/**
     * Returns Total number of spams reported by recipients
     * @return {Number}
     */
    getSpam() {
        return this.spam;
    ...
    /**
     * Sets Total number of spams reported by recipients
     * @param {Number} spam Total number of spams reported by recipients
     */
    setSpam(spam) {
        this['spam'] = spam;
    }
 ...
 */
AggregatedEmailStats.prototype['delivered'] = undefined;
 ...
 */
AggregatedEmailStats.prototype['hardBounced'] = undefined;

/**
 * Total number of soft bounce errors
 * @member {Number} softBounced
 */
AggregatedEmailStats.prototype['softBounced'] = undefined;

/**
 * Total number of emails opened by recipients
 * @member {Number} opened
 */
AggregatedEmailStats.prototype['opened'] = undefined;

/**
 * Total number of links clicked by recipients
 * @member {Number} clicked
 */
AggregatedEmailStats.prototype['clicked'] = undefined;

/**
 * Total number of unsubscribed recipients
 * @member {Number} unsubscribed
 */
AggregatedEmailStats.prototype['unsubscribed'] = undefined;

/**
 * Total number of spams reported by recipients
 * @member {Number} spam
 */
AggregatedEmailStats.prototype['spam'] = undefined;
...
export default AggregatedEmailStats;
