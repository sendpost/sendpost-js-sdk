...
/**
 * The EmailMessageToInnerBccInner model module.
 * @module sendpost/model/EmailMessageToInnerBccInner
 * @version 2.0.1
 */
class EmailMessageToInnerBccInner {
    /**
     * Constructs a new <code>EmailMessageToInnerBccInner</code>.
     * @alias module:sendpost/model/EmailMessageToInnerBccInner
     */
    constructor() { 
        
        EmailMessageToInnerBccInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>EmailMessageToInnerBccInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:sendpost/model/EmailMessageToInnerBccInner} obj Optional instance to populate.
     * @return {module:sendpost/model/EmailMessageToInnerBccInner} The populated <code>EmailMessageToInnerBccInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EmailMessageToInnerBccInner();
    ...
    /**
     * Validates the JSON data with respect to <code>EmailMessageToInnerBccInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EmailMessageToInnerBccInner</code>.
     */
 ...
 * @member {String} name
 */
EmailMessageToInnerBccInner.prototype['name'] = undefined;

/**
 * @member {String} email
 */
EmailMessageToInnerBccInner.prototype['email'] = undefined;

/**
 * @member {Object.<String, String>} customFields
 */
EmailMessageToInnerBccInner.prototype['customFields'] = undefined;
...
export default EmailMessageToInnerBccInner;
