...
class EventMetadata {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('os')) {
                obj['os'] = OperatingSystem.constructFromObject(data['os']);
            }
            if (data.hasOwnProperty('device')) {
                obj['device'] = Device.constructFromObject(data['device']);
            }
            if (data.hasOwnProperty('geo')) {
                obj['geo'] = GeoLocation.constructFromObject(data['geo']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['os']) { // data not null
          OperatingSystem.validateJSON(data['os']);
        }
        ...
        if (data['geo']) { // data not null
          GeoLocation.validateJSON(data['geo']);
        }
        // ensure the json data is a string
...
/**
     * @return {module:sendpost/model/OperatingSystem}
     */
    getOs() {
        return this.os;
    }
    ...
    /**
     * @param {module:sendpost/model/OperatingSystem} os
     */
    setOs(os) {
        this['os'] = os;
    }
...
/**
     * @return {module:sendpost/model/GeoLocation}
     */
    getGeo() {
        return this.geo;
    }
    ...
    /**
     * @param {module:sendpost/model/GeoLocation} geo
     */
    setGeo(geo) {
        this['geo'] = geo;
    }
...
/**
 * @member {module:sendpost/model/OperatingSystem} os
 */
...
/**
 * @member {module:sendpost/model/GeoLocation} geo
 */
