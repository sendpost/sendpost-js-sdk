...
/**
 * The DeleteSubAccountResponse model module.
 * @module sendpost/model/DeleteSubAccountResponse
 * @version 1.0.0
 */
class DeleteSubAccountResponse {
    /**
     * Constructs a new <code>DeleteSubAccountResponse</code>.
     * @alias module:sendpost/model/DeleteSubAccountResponse
     */
    constructor() { 
        
        DeleteSubAccountResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DeleteSubAccountResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:sendpost/model/DeleteSubAccountResponse} obj Optional instance to populate.
     * @return {module:sendpost/model/DeleteSubAccountResponse} The populated <code>DeleteSubAccountResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteSubAccountResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteSubAccountResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteSubAccountResponse</code>.
     */
...
/**
     * Returns Unique ID for the deleted sub-account.
     * @return {Number}
     */
    getId() {
        return this.id;
    ...
    /**
     * Sets Unique ID for the deleted sub-account.
     * @param {Number} id Unique ID for the deleted sub-account.
     */
    setId(id) {
        this['id'] = id;
    }
/**
    ...
    /**
     * Sets Message confirming the deletion.
     * @param {String} message Message confirming the deletion.
     */
    setMessage(message) {
 ...
 * @member {Number} id
 */
DeleteSubAccountResponse.prototype['id'] = undefined;

/**
 * Message confirming the deletion.
 * @member {String} message
 */
DeleteSubAccountResponse.prototype['message'] = undefined;
...
export default DeleteSubAccountResponse;
