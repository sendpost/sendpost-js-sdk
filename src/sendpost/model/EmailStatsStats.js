...
class EmailStatsStats {
    /**
     * Constructs a new <code>EmailStatsStats</code>.
     * @alias module:sendpost/model/EmailStatsStats
     */
    constructor() { 
        
        EmailStatsStats.initialize(this);
    }
    ...
    /**
     * Constructs a <code>EmailStatsStats</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:sendpost/model/EmailStatsStats} obj Optional instance to populate.
     * @return {module:sendpost/model/EmailStatsStats} The populated <code>EmailStatsStats</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EmailStatsStats();
    ...
    /**
     * Validates the JSON data with respect to <code>EmailStatsStats</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EmailStatsStats</code>.
     */
...
/**
    ...
    /**
     * Sets Number of emails successfully delivered to SMTP without errors
     * @param {Number} delivered Number of emails successfully delivered to SMTP without errors
     */
    setDelivered(delivered) {
        this['delivered'] = delivered;
    }
/**
     * Returns Number of emails dropped without attempting to deliver due to invalid email or suppression list
     * @return {Number}
     */
    getDropped() {
        return this.dropped;
    ...
    /**
     * Sets Number of emails dropped without attempting to deliver due to invalid email or suppression list
     * @param {Number} dropped Number of emails dropped without attempting to deliver due to invalid email or suppression list
     */
    setDropped(dropped) {
...
/**
    ...
    /**
     * Sets Number of emails that resulted in a hard bounce error
     * @param {Number} hardBounced Number of emails that resulted in a hard bounce error
     */
    setHardBounced(hardBounced) {
        this['hardBounced'] = hardBounced;
    }
/**
     * Returns Number of emails that resulted in a temporary soft bounce error
     * @return {Number}
     */
    getSoftBounced() {
    ...
    /**
     * Sets Number of emails that resulted in a temporary soft bounce error
     * @param {Number} softBounced Number of emails that resulted in a temporary soft bounce error
     */
...
/**
     * Returns Number of email recipients who unsubscribed
     * @return {Number}
     */
    getUnsubscribed() {
    ...
    /**
     * Sets Number of email recipients who unsubscribed
     * @param {Number} unsubscribed Number of email recipients who unsubscribed
     */
    setUnsubscribed(unsubscribed) {
        this['unsubscribed'] = unsubscribed;
    }
/**
     * Returns Number of emails marked as spam by recipients
     * @return {Number}
     */
    getSpam() {
        return this.spam;
    ...
    /**
     * Sets Number of emails marked as spam by recipients
     * @param {Number} spam Number of emails marked as spam by recipients
     */
    setSpam(spam) {
        this['spam'] = spam;
    }
 ...
 */
EmailStatsStats.prototype['delivered'] = undefined;
...
export default EmailStatsStats;
