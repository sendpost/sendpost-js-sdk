...
/**
 * The DomainDmarc model module.
 * @module sendpost/model/DomainDmarc
 * @version 2.0.1
 */
class DomainDmarc {
    /**
     * Constructs a new <code>DomainDmarc</code>.
     * DMARC record host, type and value
     * @alias module:sendpost/model/DomainDmarc
     */
    constructor() { 
        
        DomainDmarc.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DomainDmarc</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:sendpost/model/DomainDmarc} obj Optional instance to populate.
     * @return {module:sendpost/model/DomainDmarc} The populated <code>DomainDmarc</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DomainDmarc();
    ...
    /**
     * Validates the JSON data with respect to <code>DomainDmarc</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DomainDmarc</code>.
     */
 ...
 * @member {String} host
 */
DomainDmarc.prototype['host'] = undefined;

/**
 * @member {String} type
 */
DomainDmarc.prototype['type'] = undefined;

/**
 * @member {String} textValue
 */
DomainDmarc.prototype['textValue'] = undefined;
