...
import EmailStatsStats from './EmailStatsStats';
...
class EmailStats {
    /**
     * Constructs a new <code>EmailStats</code>.
     * @alias module:sendpost/model/EmailStats
     */
    constructor() { 
        
        EmailStats.initialize(this);
    }
    ...
    /**
     * Constructs a <code>EmailStats</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:sendpost/model/EmailStats} obj Optional instance to populate.
     * @return {module:sendpost/model/EmailStats} The populated <code>EmailStats</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EmailStats();

            if (data.hasOwnProperty('date')) {
                obj['date'] = ApiClient.convertToType(data['date'], 'Date');
            }
            if (data.hasOwnProperty('stats')) {
                obj['stats'] = EmailStatsStats.constructFromObject(data['stats']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>EmailStats</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EmailStats</code>.
     */
    static validateJSON(data) {
        // validate the optional field `stats`
        if (data['stats']) { // data not null
          EmailStatsStats.validateJSON(data['stats']);
        }
...
/**
     * Returns The UTC date for which stats are retrieved
     * @return {Date}
     */
    getDate() {
        return this.date;
    ...
    /**
     * Sets The UTC date for which stats are retrieved
     * @param {Date} date The UTC date for which stats are retrieved
     */
    setDate(date) {
        this['date'] = date;
    }
/**
     * @return {module:sendpost/model/EmailStatsStats}
     */
    getStats() {
        return this.stats;
    }
    ...
    /**
     * @param {module:sendpost/model/EmailStatsStats} stats
     */
    setStats(stats) {
        this['stats'] = stats;
    }
 ...
 * @member {Date} date
 */
EmailStats.prototype['date'] = undefined;

/**
 * @member {module:sendpost/model/EmailStatsStats} stats
 */
EmailStats.prototype['stats'] = undefined;
