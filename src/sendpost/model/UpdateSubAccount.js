...
/**
 * The UpdateSubAccount model module.
 * @module sendpost/model/UpdateSubAccount
 * @version 2.0.1
 */
class UpdateSubAccount {
    /**
     * Constructs a new <code>UpdateSubAccount</code>.
     * @alias module:sendpost/model/UpdateSubAccount
     */
    constructor() { 
        
        UpdateSubAccount.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateSubAccount</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:sendpost/model/UpdateSubAccount} obj Optional instance to populate.
     * @return {module:sendpost/model/UpdateSubAccount} The populated <code>UpdateSubAccount</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateSubAccount();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateSubAccount</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateSubAccount</code>.
     */
...
/**
     * Returns New name for the sub-account.
     * @return {String}
     */
    getName() {
        return this.name;
    ...
    /**
     * Sets New name for the sub-account.
     * @param {String} name New name for the sub-account.
     */
    setName(name) {
        this['name'] = name;
    }
 ...
 * @member {String} name
 */
UpdateSubAccount.prototype['name'] = undefined;
