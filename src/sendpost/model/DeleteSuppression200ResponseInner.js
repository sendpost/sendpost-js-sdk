...
/**
 * The DeleteSuppression200ResponseInner model module.
 * @module sendpost/model/DeleteSuppression200ResponseInner
 * @version 1.0.0
 */
class DeleteSuppression200ResponseInner {
    /**
     * Constructs a new <code>DeleteSuppression200ResponseInner</code>.
     * @alias module:sendpost/model/DeleteSuppression200ResponseInner
     */
    constructor() { 
        
        DeleteSuppression200ResponseInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DeleteSuppression200ResponseInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:sendpost/model/DeleteSuppression200ResponseInner} obj Optional instance to populate.
     * @return {module:sendpost/model/DeleteSuppression200ResponseInner} The populated <code>DeleteSuppression200ResponseInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteSuppression200ResponseInner();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteSuppression200ResponseInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteSuppression200ResponseInner</code>.
     */
...
/**
     * Returns The ID of the deleted suppression
     * @return {Number}
     */
    getId() {
        return this.id;
    ...
    /**
     * Sets The ID of the deleted suppression
     * @param {Number} id The ID of the deleted suppression
     */
    setId(id) {
        this['id'] = id;
    }
/**
     * Returns A success message after the suppression(s) are deleted
     * @return {String}
     */
    getMessage() {
        return this.message;
    ...
    /**
     * Sets A success message after the suppression(s) are deleted
     * @param {String} message A success message after the suppression(s) are deleted
     */
    setMessage(message) {
 ...
 * @member {Number} id
 */
DeleteSuppression200ResponseInner.prototype['id'] = undefined;

/**
 * A success message after the suppression(s) are deleted
 * @member {String} message
 */
DeleteSuppression200ResponseInner.prototype['message'] = undefined;
...
export default DeleteSuppression200ResponseInner;
