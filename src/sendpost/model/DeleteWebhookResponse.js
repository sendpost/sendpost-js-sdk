 ...
 * @module sendpost/model/DeleteWebhookResponse
 * @version 2.0.1
 */
class DeleteWebhookResponse {
    /**
     * Constructs a new <code>DeleteWebhookResponse</code>.
     * @alias module:sendpost/model/DeleteWebhookResponse
     */
    constructor() { 
        
        DeleteWebhookResponse.initialize(this);
    }
     ...
     * @param {module:sendpost/model/DeleteWebhookResponse} obj Optional instance to populate.
     * @return {module:sendpost/model/DeleteWebhookResponse} The populated <code>DeleteWebhookResponse</code> instance.
     */
...
/**
     * Returns Unique ID of the deleted webhook.
     * @return {Number}
     */
    getId() {
        return this.id;
    ...
    /**
     * Sets Unique ID of the deleted webhook.
     * @param {Number} id Unique ID of the deleted webhook.
     */
    setId(id) {
        this['id'] = id;
    }
 ...
 * @member {Number} id
 */
DeleteWebhookResponse.prototype['id'] = undefined;

/**
 * Success message.
 * @member {String} message
 */
DeleteWebhookResponse.prototype['message'] = undefined;
