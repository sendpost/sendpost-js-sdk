...
/**
 * The EmailMessageToInnerCcInner model module.
 * @module sendpost/model/EmailMessageToInnerCcInner
 * @version 2.0.1
 */
class EmailMessageToInnerCcInner {
    /**
     * Constructs a new <code>EmailMessageToInnerCcInner</code>.
     * @alias module:sendpost/model/EmailMessageToInnerCcInner
     */
    constructor() { 
        
        EmailMessageToInnerCcInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>EmailMessageToInnerCcInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:sendpost/model/EmailMessageToInnerCcInner} obj Optional instance to populate.
     * @return {module:sendpost/model/EmailMessageToInnerCcInner} The populated <code>EmailMessageToInnerCcInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EmailMessageToInnerCcInner();
    ...
    /**
     * Validates the JSON data with respect to <code>EmailMessageToInnerCcInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EmailMessageToInnerCcInner</code>.
     */
 ...
 * @member {String} name
 */
EmailMessageToInnerCcInner.prototype['name'] = undefined;

/**
 * @member {String} email
 */
EmailMessageToInnerCcInner.prototype['email'] = undefined;

/**
 * @member {Object.<String, String>} customFields
 */
EmailMessageToInnerCcInner.prototype['customFields'] = undefined;
...
export default EmailMessageToInnerCcInner;
