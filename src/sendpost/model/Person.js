 ...
 * @module sendpost/model/Person
 * @version 1.0.0
 */
class Person {
    /**
     * Constructs a new <code>Person</code>.
     * @alias module:sendpost/model/Person
     */
    constructor() { 
     ...
     * @param {module:sendpost/model/Person} obj Optional instance to populate.
     * @return {module:sendpost/model/Person} The populated <code>Person</code> instance.
     */
...
/**
     * Returns Email address of the person.
     * @return {String}
     */
    getEmail() {
        return this.email;
