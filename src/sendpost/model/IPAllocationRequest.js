...
/**
 * The IPAllocationRequest model module.
 * @module sendpost/model/IPAllocationRequest
 * @version 1.0.0
 */
class IPAllocationRequest {
    /**
     * Constructs a new <code>IPAllocationRequest</code>.
     * @alias module:sendpost/model/IPAllocationRequest
     * @param overflowPool {Boolean} Determines whether emails should be sent over shared IP when the IP pool is full
     * @param ips {Array.<String>} 
     */
    constructor(overflowPool, ips) { 
        
        IPAllocationRequest.initialize(this, overflowPool, ips);
    }
     ...
     */
    static initialize(obj, overflowPool, ips) { 
        obj['overflowPool'] = overflowPool;
        obj['ips'] = ips;
    }

    /**
     * Constructs a <code>IPAllocationRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:sendpost/model/IPAllocationRequest} obj Optional instance to populate.
     * @return {module:sendpost/model/IPAllocationRequest} The populated <code>IPAllocationRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new IPAllocationRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>IPAllocationRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>IPAllocationRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of IPAllocationRequest.RequiredProperties) {
...
/**
     * Returns Determines whether emails should be sent over shared IP when the IP pool is full
     * @return {Boolean}
     */
    getOverflowPool() {
    ...
    /**
     * Sets Determines whether emails should be sent over shared IP when the IP pool is full
     * @param {Boolean} overflowPool Determines whether emails should be sent over shared IP when the IP pool is full
     */
...
IPAllocationRequest.RequiredProperties = ["overflowPool", "ips"];

/**
 * Determines whether emails should be sent over shared IP when the IP pool is full
 * @member {Boolean} overflowPool
 */
IPAllocationRequest.prototype['overflowPool'] = undefined;

/**
 * @member {Array.<String>} ips
 */
IPAllocationRequest.prototype['ips'] = undefined;
