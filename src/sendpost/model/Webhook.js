...
class Webhook {
     ...
     * @alias module:sendpost/model/Webhook
     * @extends Object
     */
    constructor() { 
     ...
     * @param {module:sendpost/model/Webhook} obj Optional instance to populate.
     * @return {module:sendpost/model/Webhook} The populated <code>Webhook</code> instance.
     */
...
/**
     * Returns Unique ID for the webhook.
     * @return {Number}
     */
    getId() {
        return this.id;
    ...
    /**
     * Sets Unique ID for the webhook.
     * @param {Number} id Unique ID for the webhook.
     */
    setId(id) {
        this['id'] = id;
    }
/**
     * Returns Indicates if the webhook is active or paused.
     * @return {Boolean}
     */
    getEnabled() {
        return this.enabled;
    ...
    /**
     * Sets Indicates if the webhook is active or paused.
     * @param {Boolean} enabled Indicates if the webhook is active or paused.
     */
    setEnabled(enabled) {
        this['enabled'] = enabled;
    }
/**
     * Returns URL endpoint to which webhook calls need to be made.
     * @return {String}
     */
    getUrl() {
        return this.url;
    ...
    /**
     * Sets URL endpoint to which webhook calls need to be made.
     * @param {String} url URL endpoint to which webhook calls need to be made.
     */
    setUrl(url) {
        this['url'] = url;
    }
...
/**
     * Returns UNIX epoch nano timestamp when the webhook was created.
     * @return {Number}
     */
    getCreated() {
        return this.created;
    ...
    /**
     * Sets UNIX epoch nano timestamp when the webhook was created.
     * @param {Number} created UNIX epoch nano timestamp when the webhook was created.
     */
    setCreated(created) {
