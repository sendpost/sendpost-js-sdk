...
/**
 * The AggregateStat model module.
 * @module sendpost/model/AggregateStat
 * @version 2.0.1
 */
class AggregateStat {
    /**
     * Constructs a new <code>AggregateStat</code>.
     * @alias module:sendpost/model/AggregateStat
     */
    constructor() { 
        
        AggregateStat.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AggregateStat</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:sendpost/model/AggregateStat} obj Optional instance to populate.
     * @return {module:sendpost/model/AggregateStat} The populated <code>AggregateStat</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AggregateStat();
    ...
    /**
     * Validates the JSON data with respect to <code>AggregateStat</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AggregateStat</code>.
     */
 ...
 */
AggregateStat.prototype['delivered'] = undefined;
 ...
 */
AggregateStat.prototype['hardBounced'] = undefined;
 ...
 */
AggregateStat.prototype['unsubscribed'] = undefined;

/**
 * Number of email recipients who marked emails as spam
 * @member {Number} spam
 */
AggregateStat.prototype['spam'] = undefined;
