...
class DomainTrack {
    ...
    /**
     * Constructs a <code>DomainTrack</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:sendpost/model/DomainTrack} obj Optional instance to populate.
     * @return {module:sendpost/model/DomainTrack} The populated <code>DomainTrack</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DomainTrack();
    ...
    /**
     * Validates the JSON data with respect to <code>DomainTrack</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DomainTrack</code>.
     */
 ...
 * @member {String} host
 */
DomainTrack.prototype['host'] = undefined;

/**
 * @member {String} type
 */
DomainTrack.prototype['type'] = undefined;

/**
 * @member {String} textValue
 */
DomainTrack.prototype['textValue'] = undefined;
