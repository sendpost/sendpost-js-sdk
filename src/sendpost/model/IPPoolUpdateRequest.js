...
class IPPoolUpdateRequest {
    /**
     * Constructs a new <code>IPPoolUpdateRequest</code>.
     * @alias module:sendpost/model/IPPoolUpdateRequest
     */
    constructor() { 
        
        IPPoolUpdateRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>IPPoolUpdateRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:sendpost/model/IPPoolUpdateRequest} obj Optional instance to populate.
     * @return {module:sendpost/model/IPPoolUpdateRequest} The populated <code>IPPoolUpdateRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new IPPoolUpdateRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>IPPoolUpdateRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>IPPoolUpdateRequest</code>.
     */
 ...
 * @member {String} name
 */
IPPoolUpdateRequest.prototype['name'] = undefined;

/**
 * @member {Array.<module:sendpost/model/IP>} ips
 */
IPPoolUpdateRequest.prototype['ips'] = undefined;

/**
 * @member {Number} routingStrategy
 */
IPPoolUpdateRequest.prototype['routingStrategy'] = undefined;

/**
 * @member {String} routingMetaData
 */
IPPoolUpdateRequest.prototype['routingMetaData'] = undefined;
...
export default IPPoolUpdateRequest;
