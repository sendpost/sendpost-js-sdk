...
/**
 * The IPPoolDeleteResponse model module.
 * @module sendpost/model/IPPoolDeleteResponse
 * @version 2.0.1
 */
class IPPoolDeleteResponse {
    /**
     * Constructs a new <code>IPPoolDeleteResponse</code>.
     * @alias module:sendpost/model/IPPoolDeleteResponse
     */
    constructor() { 
        
        IPPoolDeleteResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>IPPoolDeleteResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:sendpost/model/IPPoolDeleteResponse} obj Optional instance to populate.
     * @return {module:sendpost/model/IPPoolDeleteResponse} The populated <code>IPPoolDeleteResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new IPPoolDeleteResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>IPPoolDeleteResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>IPPoolDeleteResponse</code>.
     */
 ...
 * @member {Number} id
 */
IPPoolDeleteResponse.prototype['id'] = undefined;

/**
 * @member {String} message
 */
IPPoolDeleteResponse.prototype['message'] = undefined;
...
export default IPPoolDeleteResponse;
