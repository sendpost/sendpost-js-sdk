...
/**
 * The MessageHeaderTo model module.
 * @module sendpost/model/MessageHeaderTo
 * @version 2.0.1
 */
class MessageHeaderTo {
    /**
     * Constructs a new <code>MessageHeaderTo</code>.
     * Header To recipient object comprising name, email, cc, bcc and customFields
     * @alias module:sendpost/model/MessageHeaderTo
     */
    constructor() { 
        
        MessageHeaderTo.initialize(this);
    }
    ...
    /**
     * Constructs a <code>MessageHeaderTo</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:sendpost/model/MessageHeaderTo} obj Optional instance to populate.
     * @return {module:sendpost/model/MessageHeaderTo} The populated <code>MessageHeaderTo</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MessageHeaderTo();
    ...
    /**
     * Validates the JSON data with respect to <code>MessageHeaderTo</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MessageHeaderTo</code>.
     */
...
/**
    ...
    /**
     * Sets List of CC recipients
     * @param {Array.<String>} cc List of CC recipients
     */
    setCc(cc) {
        this['cc'] = cc;
    }
/**
    ...
    /**
     * Sets List of BCC recipients
     * @param {Array.<String>} bcc List of BCC recipients
     */
    setBcc(bcc) {
        this['bcc'] = bcc;
    }
/**
     * Returns Key-Value pair of custom fields.
    ...
    /**
     * Sets Key-Value pair of custom fields.
     * @param {Object.<String, String>} customFields Key-Value pair of custom fields.
     */
 ...
 * @member {String} name
 */
MessageHeaderTo.prototype['name'] = undefined;

/**
 * Email address of the recipient.
 * @member {String} email
 */
MessageHeaderTo.prototype['email'] = undefined;

/**
 * List of CC recipients
 * @member {Array.<String>} cc
 */
MessageHeaderTo.prototype['cc'] = undefined;

/**
 * List of BCC recipients
 * @member {Array.<String>} bcc
 */
MessageHeaderTo.prototype['bcc'] = undefined;

/**
 * Key-Value pair of custom fields.
 * @member {Object.<String, String>} customFields
 */
MessageHeaderTo.prototype['customFields'] = undefined;
...
export default MessageHeaderTo;
