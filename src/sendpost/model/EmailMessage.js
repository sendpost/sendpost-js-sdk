...
import EmailMessageFrom from './EmailMessageFrom';
import EmailMessageReplyTo from './EmailMessageReplyTo';
import EmailMessageToInner from './EmailMessageToInner';
...
class EmailMessage {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('from')) {
                obj['from'] = EmailMessageFrom.constructFromObject(data['from']);
            }
            if (data.hasOwnProperty('replyTo')) {
                obj['replyTo'] = EmailMessageReplyTo.constructFromObject(data['replyTo']);
            }
            if (data.hasOwnProperty('to')) {
                obj['to'] = ApiClient.convertToType(data['to'], [EmailMessageToInner]);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['from']) { // data not null
          EmailMessageFrom.validateJSON(data['from']);
        }
        // validate the optional field `replyTo`
        if (data['replyTo']) { // data not null
          EmailMessageReplyTo.validateJSON(data['replyTo']);
        }
        if (data['to']) { // data not null
            ...
            for (const item of data['to']) {
                EmailMessageToInner.validateJSON(item);
            };
        }
        // ensure the json data is an array
...
/**
     * @return {module:sendpost/model/EmailMessageFrom}
     */
    getFrom() {
        return this.from;
    }
    ...
    /**
     * @param {module:sendpost/model/EmailMessageFrom} from
     */
    setFrom(from) {
        this['from'] = from;
    }
/**
     * @return {module:sendpost/model/EmailMessageReplyTo}
     */
    getReplyTo() {
        return this.replyTo;
    }
    ...
    /**
     * @param {module:sendpost/model/EmailMessageReplyTo} replyTo
     */
    setReplyTo(replyTo) {
        this['replyTo'] = replyTo;
    }
/**
     * @return {Array.<module:sendpost/model/EmailMessageToInner>}
     */
    getTo() {
        return this.to;
    }
    ...
    /**
     * @param {Array.<module:sendpost/model/EmailMessageToInner>} to
     */
    setTo(to) {
        this['to'] = to;
    }
 ...
 */
EmailMessage.prototype['messageID'] = undefined;

/**
 * @member {Number} accountID
 */
EmailMessage.prototype['accountID'] = undefined;

/**
 * @member {Number} subAccountID
 */
EmailMessage.prototype['subAccountID'] = undefined;

/**
 * @member {Number} ipID
 */
EmailMessage.prototype['ipID'] = undefined;

/**
 * @member {String} publicIP
 */
EmailMessage.prototype['publicIP'] = undefined;

/**
 * @member {String} localIP
 */
EmailMessage.prototype['localIP'] = undefined;

/**
 * @member {String} emailType
 */
EmailMessage.prototype['emailType'] = undefined;

/**
 * @member {Number} submittedAt
 */
EmailMessage.prototype['submittedAt'] = undefined;

/**
 * @member {module:sendpost/model/EmailMessageFrom} from
 */
EmailMessage.prototype['from'] = undefined;

/**
 * @member {module:sendpost/model/EmailMessageReplyTo} replyTo
 */
EmailMessage.prototype['replyTo'] = undefined;

/**
 * @member {Array.<module:sendpost/model/EmailMessageToInner>} to
 */
 ...
 */
EmailMessage.prototype['customFields'] = undefined;
 ...
 */
EmailMessage.prototype['webhookEndpoint'] = undefined;
