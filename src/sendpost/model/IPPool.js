...
import IP from './IP';
import ThirdPartySendingProvider from './ThirdPartySendingProvider';
...
class IPPool {
     ...
     * @alias module:sendpost/model/IPPool
     */
    constructor() { 
     ...
     * @param {module:sendpost/model/IPPool} obj Optional instance to populate.
     * @return {module:sendpost/model/IPPool} The populated <code>IPPool</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('ips')) {
                obj['ips'] = ApiClient.convertToType(data['ips'], [IP]);
            }
            ...
            if (data.hasOwnProperty('ipDomainWarmupStatus')) {
                obj['ipDomainWarmupStatus'] = ApiClient.convertToType(data['ipDomainWarmupStatus'], 'String');
            }
    ...
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['ipDomainWarmupStatus'] && !(typeof data['ipDomainWarmupStatus'] === 'string' || data['ipDomainWarmupStatus'] instanceof String)) {
            throw new Error("Expected the field `ipDomainWarmupStatus` to be a primitive type in the JSON string but got " + data['ipDomainWarmupStatus']);
        }
        // ensure the json data is a string
...
/**
     * @return {Array.<module:sendpost/model/IP>}
     */
    getIps() {
        return this.ips;
    }
    ...
    /**
     * @param {Array.<module:sendpost/model/IP>} ips
     */
    setIps(ips) {
        this['ips'] = ips;
    }
/**
     * @return {Array.<module:sendpost/model/ThirdPartySendingProvider>}
     */
    getThirdPartySendingProviders() {
        return this.thirdPartySendingProviders;
    }

    /**
     * @param {Array.<module:sendpost/model/ThirdPartySendingProvider>} thirdPartySendingProviders
     */
...
/**
    ...
    /**
     * @param {String} routingMetaData
     */
    setRoutingMetaData(routingMetaData) {
...
/**
    ...
    /**
     * @param {Boolean} autoWarmupEnabled
     */
...
/**
    ...
    getIpDomainWarmupStatus() {
        return this.ipDomainWarmupStatus;
    }

    /**
     * @param {String} ipDomainWarmupStatus
     */
    setIpDomainWarmupStatus(ipDomainWarmupStatus) {
        this['ipDomainWarmupStatus'] = ipDomainWarmupStatus;
    }
/**
     * Returns Indicates whether the IP should overflow, once email capacity of the IP Pool has been reached, should we send remaining emails over shared IP or not
     * @return {Boolean}
     */
    getShouldOverflow() {
    ...
    /**
     * Sets Indicates whether the IP should overflow, once email capacity of the IP Pool has been reached, should we send remaining emails over shared IP or not
     * @param {Boolean} shouldOverflow Indicates whether the IP should overflow, once email capacity of the IP Pool has been reached, should we send remaining emails over shared IP or not
     */
    setShouldOverflow(shouldOverflow) {
        this['shouldOverflow'] = shouldOverflow;
    }
/**
     * Returns The name of the overflow pool
     * @return {String}
     */
    getOverflowPoolName() {
    ...
    /**
     * Sets The name of the overflow pool
     * @param {String} overflowPoolName The name of the overflow pool
     */
    setOverflowPoolName(overflowPoolName) {
        this['overflowPoolName'] = overflowPoolName;
    }
/**
     * Returns The interval for the warmup
     * @return {Number}
     */
    getWarmupInterval() {
    ...
    /**
     * Sets The interval for the warmup
     * @param {Number} warmupInterval The interval for the warmup
     */
...
/**
 * @member {Array.<module:sendpost/model/IP>} ips
 */
IPPool.prototype['ips'] = undefined;
 ...
 */
IPPool.prototype['routingStrategy'] = undefined;

/**
 * @member {String} routingMetaData
 */
IPPool.prototype['routingMetaData'] = undefined;

/**
 * @member {Boolean} autoWarmupEnabled
 */
IPPool.prototype['autoWarmupEnabled'] = undefined;

/**
 * @member {Boolean} infraMonitor
 */
IPPool.prototype['infraMonitor'] = undefined;

/**
 * @member {String} ipDomainWarmupStatus
 */
IPPool.prototype['ipDomainWarmupStatus'] = undefined;
 ...
 */
IPPool.prototype['shouldOverflow'] = undefined;

/**
 * The name of the overflow pool
 * @member {String} overflowPoolName
 */
IPPool.prototype['overflowPoolName'] = undefined;

/**
 * The interval for the warmup
 * @member {Number} warmupInterval
 */
IPPool.prototype['warmupInterval'] = undefined;
