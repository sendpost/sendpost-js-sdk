...
/**
 * The CreateSuppressionRequestSpamComplaintInner model module.
 * @module sendpost/model/CreateSuppressionRequestSpamComplaintInner
 * @version 1.0.0
 */
class CreateSuppressionRequestSpamComplaintInner {
    /**
     * Constructs a new <code>CreateSuppressionRequestSpamComplaintInner</code>.
     * @alias module:sendpost/model/CreateSuppressionRequestSpamComplaintInner
     */
    constructor() { 
        
        CreateSuppressionRequestSpamComplaintInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateSuppressionRequestSpamComplaintInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:sendpost/model/CreateSuppressionRequestSpamComplaintInner} obj Optional instance to populate.
     * @return {module:sendpost/model/CreateSuppressionRequestSpamComplaintInner} The populated <code>CreateSuppressionRequestSpamComplaintInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateSuppressionRequestSpamComplaintInner();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateSuppressionRequestSpamComplaintInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateSuppressionRequestSpamComplaintInner</code>.
     */
 ...
 * @member {String} email
 */
CreateSuppressionRequestSpamComplaintInner.prototype['email'] = undefined;
...
export default CreateSuppressionRequestSpamComplaintInner;
