...
export default class WebhookApi {
    ...
    * @alias module:sendpost/api/WebhookApi
    * @class
    ...
    */
     ...
     * @param {Number} webhookId ID of the webhook to delete.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:sendpost/model/DeleteWebhookResponse} and HTTP response
     */
    deleteWebhookWithHttpInfo(webhookId) {
      ...
      return this.apiClient.callApi(
        '/account/webhook/{webhook_id}', 'DELETE',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
     ...
     * Delete a webhook by its ID.
     * @param {Number} webhookId ID of the webhook to delete.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:sendpost/model/DeleteWebhookResponse}
     */
     ...
     * @param {String} [search] Case insensitive search against webhook URL.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link Array.<module:sendpost/model/Webhook>} and HTTP response
     */
    getAllWebhooksWithHttpInfo(opts) {
      opts = opts || {};
      let postBody = null;
     ...
     * @param {String} opts.search Case insensitive search against webhook URL.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link Array.<module:sendpost/model/Webhook>}
     */
    getAllWebhooks(opts) {
      return this.getAllWebhooksWithHttpInfo(opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @param {Number} webhookId The ID of the webhook to retrieve.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:sendpost/model/Webhook} and HTTP response
     */
    getWebhookWithHttpInfo(webhookId) {
      ...
      let returnType = Webhook;
      return this.apiClient.callApi(
        '/account/webhook/{webhook_id}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
     ...
     * @param {module:sendpost/model/UpdateWebhook} updateWebhook 
     * @param {Number} webhookId ID of the webhook to update.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:sendpost/model/Webhook} and HTTP response
     */
    updateWebhookWithHttpInfo(updateWebhook, webhookId) {
      let postBody = updateWebhook;
      ...
      let returnType = Webhook;
      return this.apiClient.callApi(
        '/account/webhook/{webhook_id}', 'PUT',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:sendpost/model/Webhook}
     */
    updateWebhook(updateWebhook, webhookId) {
      return this.updateWebhookWithHttpInfo(updateWebhook, webhookId)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
