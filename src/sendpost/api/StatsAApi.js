...
/**
* StatsA service.
* @module sendpost/api/StatsAApi
* @version 2.0.1
*/
export default class StatsAApi {

    /**
    * Constructs a new StatsAApi. 
    * @alias module:sendpost/api/StatsAApi
    * @class
    ...
    */
     ...
     * @param {Date} from The start date for retrieving aggregated stats (inclusive)
     * @param {Date} to The end date for retrieving aggregated stats (inclusive). The difference between `from` and `to` should not exceed 366 days.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:sendpost/model/AggregateStats} and HTTP response
     */
    getAccountAggregateStatsWithHttpInfo(from, to) {
      let postBody = null;
      // verify the required parameter 'from' is set
      if (from === undefined || from === null) {
        throw new Error("Missing the required parameter 'from' when calling getAccountAggregateStats");
      }
      // verify the required parameter 'to' is set
      if (to === undefined || to === null) {
        throw new Error("Missing the required parameter 'to' when calling getAccountAggregateStats");
      }
     ...
     * @param {Date} from The start date for retrieving aggregated stats (inclusive)
     * @param {Date} to The end date for retrieving aggregated stats (inclusive). The difference between `from` and `to` should not exceed 366 days.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:sendpost/model/AggregateStats}
     */
    getAccountAggregateStats(from, to) {
      return this.getAccountAggregateStatsWithHttpInfo(from, to)
     ...
     * @param {String} group Group whose aggregate stats need to be retrieved.
     * @param {Date} from Date from which stats should be retrieved (should be in the format `YYYY-MM-DD`).
     * @param {Date} to Date to which stats should be retrieved (should be in the format `YYYY-MM-DD`). Note that the difference between `from` and `to` should not be more than 366 days.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:sendpost/model/AggregateStat} and HTTP response
     */
    getAccountAggregateStatsByGroupWithHttpInfo(group, from, to) {
      let postBody = null;
      // verify the required parameter 'group' is set
      if (group === undefined || group === null) {
        throw new Error("Missing the required parameter 'group' when calling getAccountAggregateStatsByGroup");
      }
      // verify the required parameter 'from' is set
      if (from === undefined || from === null) {
        throw new Error("Missing the required parameter 'from' when calling getAccountAggregateStatsByGroup");
      }
      // verify the required parameter 'to' is set
      if (to === undefined || to === null) {
        throw new Error("Missing the required parameter 'to' when calling getAccountAggregateStatsByGroup");
      }
     ...
     * @param {Date} from Date from which stats should be retrieved (should be in the format `YYYY-MM-DD`).
     * @param {Date} to Date to which stats should be retrieved (should be in the format `YYYY-MM-DD`). Note that the difference between `from` and `to` should not be more than 366 days.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:sendpost/model/AggregateStat}
     */
    getAccountAggregateStatsByGroup(group, from, to) {
      return this.getAccountAggregateStatsByGroupWithHttpInfo(group, from, to)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @param {String} group Group whose stats need to be retrieved
     * @param {Date} from Date from which stats should be retrieved (should be in the format `YYYY-MM-DD`)
     * @param {Date} to Date to which stats should be retrieved (should be in the format `YYYY-MM-DD`). Note that the difference between `from` and `to` should not be more than 31 days.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link Array.<module:sendpost/model/Stat>} and HTTP response
     */
    getAccountStatsByGroupWithHttpInfo(group, from, to) {
      let postBody = null;
      // verify the required parameter 'group' is set
      if (group === undefined || group === null) {
        throw new Error("Missing the required parameter 'group' when calling getAccountStatsByGroup");
      }
      // verify the required parameter 'from' is set
      if (from === undefined || from === null) {
        throw new Error("Missing the required parameter 'from' when calling getAccountStatsByGroup");
      }
      // verify the required parameter 'to' is set
      if (to === undefined || to === null) {
        throw new Error("Missing the required parameter 'to' when calling getAccountStatsByGroup");
      }
     ...
     * @param {Date} from Date from which stats should be retrieved (should be in the format `YYYY-MM-DD`)
     * @param {Date} to Date to which stats should be retrieved (should be in the format `YYYY-MM-DD`). Note that the difference between `from` and `to` should not be more than 31 days.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link Array.<module:sendpost/model/Stat>}
     */
    getAccountStatsByGroup(group, from, to) {
      return this.getAccountStatsByGroupWithHttpInfo(group, from, to)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @param {Date} from The start date for retrieving stats (inclusive)
     * @param {Date} to The end date for retrieving stats (inclusive). The difference between `from` and `to` should not exceed 31 days.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link Array.<module:sendpost/model/AccountStats>} and HTTP response
     */
    getAllAccountStatsWithHttpInfo(from, to) {
      let postBody = null;
      // verify the required parameter 'from' is set
      if (from === undefined || from === null) {
        throw new Error("Missing the required parameter 'from' when calling getAllAccountStats");
      }
      // verify the required parameter 'to' is set
      if (to === undefined || to === null) {
        throw new Error("Missing the required parameter 'to' when calling getAllAccountStats");
      }
     ...
     * @param {Date} from The start date for retrieving stats (inclusive)
     * @param {Date} to The end date for retrieving stats (inclusive). The difference between `from` and `to` should not exceed 31 days.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link Array.<module:sendpost/model/AccountStats>}
     */
    getAllAccountStats(from, to) {
      return this.getAllAccountStatsWithHttpInfo(from, to)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
