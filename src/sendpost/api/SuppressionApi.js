...
export default class SuppressionApi {
    ...
    */
     ...
     * @param {module:sendpost/model/CreateSuppressionRequest} createSuppressionRequest 
     ...
     */
    createSuppressionWithHttpInfo(createSuppressionRequest) {
      let postBody = createSuppressionRequest;
      // verify the required parameter 'createSuppressionRequest' is set
      if (createSuppressionRequest === undefined || createSuppressionRequest === null) {
        throw new Error("Missing the required parameter 'createSuppressionRequest' when calling createSuppression");
      }
    ...
    createSuppression(createSuppressionRequest) {
      return this.createSuppressionWithHttpInfo(createSuppressionRequest)
     ...
     * @param {module:sendpost/model/DeleteSuppressionRequest} deleteSuppressionRequest 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link Array.<module:sendpost/model/DeleteSuppression200ResponseInner>} and HTTP response
     */
    deleteSuppressionWithHttpInfo(deleteSuppressionRequest) {
      let postBody = deleteSuppressionRequest;
      // verify the required parameter 'deleteSuppressionRequest' is set
      if (deleteSuppressionRequest === undefined || deleteSuppressionRequest === null) {
        throw new Error("Missing the required parameter 'deleteSuppressionRequest' when calling deleteSuppression");
      }
      ...
      let contentTypes = ['application/json'];
      let accepts = ['application/json'];
      let returnType = [DeleteSuppression200ResponseInner];
      return this.apiClient.callApi(
     ...
     * Deletes one or more suppressions for a given sub-account. The request can contain a list of emails to delete specific suppressions or delete a single suppression. 
     * @param {module:sendpost/model/DeleteSuppressionRequest} deleteSuppressionRequest 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link Array.<module:sendpost/model/DeleteSuppression200ResponseInner>}
     */
    deleteSuppression(deleteSuppressionRequest) {
      return this.deleteSuppressionWithHttpInfo(deleteSuppressionRequest)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @param {Date} from Start date for the suppression records
     * @param {Date} to End date for the suppression records (Note: `from` should be earlier than `to` and the date range should not exceed 60 days) 
     * @param {Object} opts Optional parameters
     * @param {Number} [limit = 20)] Number of records to return per request
     * @param {Number} [offset = 0)] Number of initial records to skip
     * @param {String} [search] Case-insensitive search against suppression email
     * @param {module:sendpost/model/String} [type] Type of suppression. Valid values: `hardBounce`, `manual`, `spamComplaint`, `unsubscribe` 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link Array.<module:sendpost/model/Suppression>} and HTTP response
     */
    getSuppressionListWithHttpInfo(from, to, opts) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'from' is set
      if (from === undefined || from === null) {
        throw new Error("Missing the required parameter 'from' when calling getSuppressionList");
      }
      // verify the required parameter 'to' is set
      if (to === undefined || to === null) {
        throw new Error("Missing the required parameter 'to' when calling getSuppressionList");
      }
     ...
     * @param {Date} to End date for the suppression records (Note: `from` should be earlier than `to` and the date range should not exceed 60 days) 
     * @param {Object} opts Optional parameters
     * @param {Number} opts.limit Number of records to return per request (default to 20)
     * @param {Number} opts.offset Number of initial records to skip (default to 0)
     * @param {String} opts.search Case-insensitive search against suppression email
     * @param {module:sendpost/model/String} opts.type Type of suppression. Valid values: `hardBounce`, `manual`, `spamComplaint`, `unsubscribe` 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link Array.<module:sendpost/model/Suppression>}
     */
    getSuppressionList(from, to, opts) {
      return this.getSuppressionListWithHttpInfo(from, to, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
