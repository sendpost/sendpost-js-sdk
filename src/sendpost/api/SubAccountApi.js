...
export default class SubAccountApi {
    ...
    /**
    * Constructs a new SubAccountApi. 
    * @alias module:sendpost/api/SubAccountApi
    * @class
    ...
    */
     ...
     * @param {Number} subaccountId The ID of the sub-account to delete.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:sendpost/model/DeleteSubAccountResponse} and HTTP response
     */
    deleteSubAccountWithHttpInfo(subaccountId) {
      let postBody = null;
      // verify the required parameter 'subaccountId' is set
      if (subaccountId === undefined || subaccountId === null) {
        throw new Error("Missing the required parameter 'subaccountId' when calling deleteSubAccount");
      }
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = DeleteSubAccountResponse;
      return this.apiClient.callApi(
        '/account/subaccount/{subaccount_id}', 'DELETE',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
     ...
     * Deletes a specific sub-account by its ID.
     * @param {Number} subaccountId The ID of the sub-account to delete.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:sendpost/model/DeleteSubAccountResponse}
     */
    deleteSubAccount(subaccountId) {
      return this.deleteSubAccountWithHttpInfo(subaccountId)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @param {String} [search] Case-insensitive search against the sub-account name.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link Array.<module:sendpost/model/SubAccount>} and HTTP response
     */
    getAllSubAccountsWithHttpInfo(opts) {
      opts = opts || {};
      let postBody = null;
     ...
     * @param {String} opts.search Case-insensitive search against the sub-account name.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link Array.<module:sendpost/model/SubAccount>}
     */
    getAllSubAccounts(opts) {
      return this.getAllSubAccountsWithHttpInfo(opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @param {Number} subaccountId The ID of the sub-account to retrieve.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:sendpost/model/SubAccount} and HTTP response
     */
    getSubAccountWithHttpInfo(subaccountId) {
      let postBody = null;
      // verify the required parameter 'subaccountId' is set
      if (subaccountId === undefined || subaccountId === null) {
        throw new Error("Missing the required parameter 'subaccountId' when calling getSubAccount");
      }
      ...
      let returnType = SubAccount;
      return this.apiClient.callApi(
        '/account/subaccount/{subaccount_id}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    getSubAccount(subaccountId) {
      return this.getSubAccountWithHttpInfo(subaccountId)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @param {module:sendpost/model/UpdateSubAccount} updateSubAccount 
     * @param {Number} subaccountId The ID of the sub-account to update.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:sendpost/model/SubAccount} and HTTP response
     */
    updateSubAccountWithHttpInfo(updateSubAccount, subaccountId) {
      let postBody = updateSubAccount;
      // verify the required parameter 'updateSubAccount' is set
      if (updateSubAccount === undefined || updateSubAccount === null) {
        throw new Error("Missing the required parameter 'updateSubAccount' when calling updateSubAccount");
      }
      // verify the required parameter 'subaccountId' is set
      if (subaccountId === undefined || subaccountId === null) {
        throw new Error("Missing the required parameter 'subaccountId' when calling updateSubAccount");
      }
      ...
      let returnType = SubAccount;
      return this.apiClient.callApi(
        '/account/subaccount/{subaccount_id}', 'PUT',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:sendpost/model/SubAccount}
     */
    updateSubAccount(updateSubAccount, subaccountId) {
      return this.updateSubAccountWithHttpInfo(updateSubAccount, subaccountId)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
