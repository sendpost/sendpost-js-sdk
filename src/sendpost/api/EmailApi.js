...
export default class EmailApi {
    ...
    */
     ...
     * @param {module:sendpost/model/EmailMessageObject} emailMessageObject Email message details
     ...
     */
    sendEmailWithHttpInfo(emailMessageObject) {
      let postBody = emailMessageObject;
      // verify the required parameter 'emailMessageObject' is set
      if (emailMessageObject === undefined || emailMessageObject === null) {
        throw new Error("Missing the required parameter 'emailMessageObject' when calling sendEmail");
      }
     ...
     */
    sendEmail(emailMessageObject) {
      return this.sendEmailWithHttpInfo(emailMessageObject)
     ...
     * @param {module:sendpost/model/EmailMessageWithTemplate} emailMessageWithTemplate Email message details with template information
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link Array.<module:sendpost/model/EmailResponse>} and HTTP response
     */
    sendEmailWithTemplateWithHttpInfo(emailMessageWithTemplate) {
      let postBody = emailMessageWithTemplate;
      // verify the required parameter 'emailMessageWithTemplate' is set
      if (emailMessageWithTemplate === undefined || emailMessageWithTemplate === null) {
        throw new Error("Missing the required parameter 'emailMessageWithTemplate' when calling sendEmailWithTemplate");
      }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link Array.<module:sendpost/model/EmailResponse>}
     */
    sendEmailWithTemplate(emailMessageWithTemplate) {
      return this.sendEmailWithTemplateWithHttpInfo(emailMessageWithTemplate)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
