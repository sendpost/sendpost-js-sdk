...
export default class DomainApi {
    ...
    * @alias module:sendpost/api/DomainApi
    * @class
    ...
    */
     ...
     * @param {String} [search] Case insensitive search against domain names
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link Array.<module:sendpost/model/Domain>} and HTTP response
     */
    getAllDomainsWithHttpInfo(opts) {
      opts = opts || {};
      let postBody = null;
     ...
     * @param {String} opts.search Case insensitive search against domain names
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link Array.<module:sendpost/model/Domain>}
     */
    getAllDomains(opts) {
      return this.getAllDomainsWithHttpInfo(opts)
     ...
     * @param {String} domainId The unique ID of the domain to delete.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:sendpost/model/DeleteResponse} and HTTP response
     */
    subaccountDomainDomainIdDeleteWithHttpInfo(domainId) {
      let postBody = null;
      // verify the required parameter 'domainId' is set
      if (domainId === undefined || domainId === null) {
        throw new Error("Missing the required parameter 'domainId' when calling subaccountDomainDomainIdDelete");
      }
      ...
      return this.apiClient.callApi(
        '/subaccount/domain/{domain_id}', 'DELETE',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
     ...
     * Delete a specific domain using its `id`.
     * @param {String} domainId The unique ID of the domain to delete.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:sendpost/model/DeleteResponse}
     */
    subaccountDomainDomainIdDelete(domainId) {
      return this.subaccountDomainDomainIdDeleteWithHttpInfo(domainId)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @param {String} domainId The unique ID of the domain to retrieve.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:sendpost/model/Domain} and HTTP response
     */
    subaccountDomainDomainIdGetWithHttpInfo(domainId) {
      let postBody = null;
      // verify the required parameter 'domainId' is set
      if (domainId === undefined || domainId === null) {
        throw new Error("Missing the required parameter 'domainId' when calling subaccountDomainDomainIdGet");
      }
      ...
      let returnType = Domain;
      return this.apiClient.callApi(
        '/subaccount/domain/{domain_id}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
     ...
     * Retrieve details of a specific domain using its `id`.
     * @param {String} domainId The unique ID of the domain to retrieve.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:sendpost/model/Domain}
     */
    subaccountDomainDomainIdGet(domainId) {
      return this.subaccountDomainDomainIdGetWithHttpInfo(domainId)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @param {module:sendpost/model/CreateDomainRequest} createDomainRequest 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:sendpost/model/Domain} and HTTP response
     */
    subaccountDomainPostWithHttpInfo(createDomainRequest) {
      ...
      if (createDomainRequest === undefined || createDomainRequest === null) {
        throw new Error("Missing the required parameter 'createDomainRequest' when calling subaccountDomainPost");
      }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:sendpost/model/Domain}
     */
    subaccountDomainPost(createDomainRequest) {
      return this.subaccountDomainPostWithHttpInfo(createDomainRequest)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
