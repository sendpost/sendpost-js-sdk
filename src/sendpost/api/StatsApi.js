...
export default class StatsApi {
    ...
    * @alias module:sendpost/api/StatsApi
    * @class
    ...
    */
     ...
     * @param {Date} from Start date for stats retrieval.
     * @param {Date} to Date to which stats should be retrieved ( Note than from date should be earlier than to date. Also the difference between from and to date shouldn't ne more than 60 days ) 
     * @param {Number} subaccountId The ID of the subaccount to retrieve
     ...
     */
    accountSubaccountStatSubaccountIdAggregateGetWithHttpInfo(from, to, subaccountId) {
      let postBody = null;
      // verify the required parameter 'from' is set
      if (from === undefined || from === null) {
        throw new Error("Missing the required parameter 'from' when calling accountSubaccountStatSubaccountIdAggregateGet");
      }
      // verify the required parameter 'to' is set
      if (to === undefined || to === null) {
        throw new Error("Missing the required parameter 'to' when calling accountSubaccountStatSubaccountIdAggregateGet");
      }
      // verify the required parameter 'subaccountId' is set
      if (subaccountId === undefined || subaccountId === null) {
        throw new Error("Missing the required parameter 'subaccountId' when calling accountSubaccountStatSubaccountIdAggregateGet");
      }
      ...
      return this.apiClient.callApi(
        '/account/subaccount/stat/{subaccount_id}/aggregate', 'GET',
     ...
     */
    accountSubaccountStatSubaccountIdAggregateGet(from, to, subaccountId) {
      return this.accountSubaccountStatSubaccountIdAggregateGetWithHttpInfo(from, to, subaccountId)
     ...
     */
    accountSubaccountStatSubaccountIdGetWithHttpInfo(from, to, subaccountId) {
      let postBody = null;
      // verify the required parameter 'from' is set
      if (from === undefined || from === null) {
        throw new Error("Missing the required parameter 'from' when calling accountSubaccountStatSubaccountIdGet");
      }
      // verify the required parameter 'to' is set
      if (to === undefined || to === null) {
        throw new Error("Missing the required parameter 'to' when calling accountSubaccountStatSubaccountIdGet");
      }
      // verify the required parameter 'subaccountId' is set
      if (subaccountId === undefined || subaccountId === null) {
        throw new Error("Missing the required parameter 'subaccountId' when calling accountSubaccountStatSubaccountIdGet");
      }
      ...
      let returnType = [Stat];
      return this.apiClient.callApi(
        '/account/subaccount/stat/{subaccount_id}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
     ...
     */
    accountSubaccountStatSubaccountIdGet(from, to, subaccountId) {
      return this.accountSubaccountStatSubaccountIdGetWithHttpInfo(from, to, subaccountId)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @param {String} group Group whose aggregated stats need to be retrieved
     * @param {Date} from The starting date for the aggregated stats
     * @param {Date} to The ending date for the aggregated stats (Note: `from` should be earlier than `to` and the date range should not exceed 366 days) 
     * @param {Number} subaccountId The ID of the subaccount to retrieve
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:sendpost/model/AggregateStat} and HTTP response
     */
    getAggregateStatsByGroupWithHttpInfo(group, from, to, subaccountId) {
      let postBody = null;
      // verify the required parameter 'group' is set
      if (group === undefined || group === null) {
        throw new Error("Missing the required parameter 'group' when calling getAggregateStatsByGroup");
      }
      // verify the required parameter 'from' is set
      if (from === undefined || from === null) {
        throw new Error("Missing the required parameter 'from' when calling getAggregateStatsByGroup");
      }
      // verify the required parameter 'to' is set
      if (to === undefined || to === null) {
        throw new Error("Missing the required parameter 'to' when calling getAggregateStatsByGroup");
      }
      // verify the required parameter 'subaccountId' is set
      if (subaccountId === undefined || subaccountId === null) {
        throw new Error("Missing the required parameter 'subaccountId' when calling getAggregateStatsByGroup");
      }
      ...
      let returnType = AggregateStat;
      return this.apiClient.callApi(
        '/account/subaccount/stat/{subaccount_id}/group', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:sendpost/model/AggregateStat}
     */
    getAggregateStatsByGroup(group, from, to, subaccountId) {
      return this.getAggregateStatsByGroupWithHttpInfo(group, from, to, subaccountId)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
