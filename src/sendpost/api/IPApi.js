...
export default class IPApi {
    ...
    * @alias module:sendpost/api/IPApi
    * @class
    ...
    */
     ...
     * @param {module:sendpost/model/IPAllocationRequest} iPAllocationRequest 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:sendpost/model/IP} and HTTP response
     */
    allocateNewIpWithHttpInfo(iPAllocationRequest) {
      let postBody = iPAllocationRequest;
      // verify the required parameter 'iPAllocationRequest' is set
      if (iPAllocationRequest === undefined || iPAllocationRequest === null) {
        throw new Error("Missing the required parameter 'iPAllocationRequest' when calling allocateNewIp");
      }
     ...
     * Allocates a new IP resource to the account. 
     * @param {module:sendpost/model/IPAllocationRequest} iPAllocationRequest 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:sendpost/model/IP}
     */
    allocateNewIp(iPAllocationRequest) {
      return this.allocateNewIpWithHttpInfo(iPAllocationRequest)
     ...
     * @param {Number} ipId The ID of the IP resource to delete
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:sendpost/model/IPDeletionResponse} and HTTP response
     */
    deleteIpWithHttpInfo(ipId) {
      let postBody = null;
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = IPDeletionResponse;
      return this.apiClient.callApi(
        '/account/ip/{ip_id}', 'DELETE',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
     ...
     * Deletes a specific IP resource based on the provided IP ID. 
     * @param {Number} ipId The ID of the IP resource to delete
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:sendpost/model/IPDeletionResponse}
     */
    deleteIp(ipId) {
     ...
     * @param {String} [search] Case insensitive search against IP's public IP address
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link Array.<module:sendpost/model/IP>} and HTTP response
     */
    getAllIpsWithHttpInfo(opts) {
      opts = opts || {};
      let postBody = null;
     ...
     * @param {String} opts.search Case insensitive search against IP's public IP address
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link Array.<module:sendpost/model/IP>}
     */
    getAllIps(opts) {
      return this.getAllIpsWithHttpInfo(opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @param {Number} ipId The ID of the IP resource to retrieve
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:sendpost/model/IP} and HTTP response
     */
    getSpecificIpWithHttpInfo(ipId) {
      let postBody = null;
      // verify the required parameter 'ipId' is set
      if (ipId === undefined || ipId === null) {
        throw new Error("Missing the required parameter 'ipId' when calling getSpecificIp");
      }
     ...
     */
    getSpecificIp(ipId) {
      return this.getSpecificIpWithHttpInfo(ipId)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @param {module:sendpost/model/IPUpdateRequest} iPUpdateRequest 
     * @param {Number} ipId The ID of the IP resource to update
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:sendpost/model/IP} and HTTP response
     */
    updateIpWithHttpInfo(iPUpdateRequest, ipId) {
      let postBody = iPUpdateRequest;
      // verify the required parameter 'iPUpdateRequest' is set
      if (iPUpdateRequest === undefined || iPUpdateRequest === null) {
        throw new Error("Missing the required parameter 'iPUpdateRequest' when calling updateIp");
      }
      // verify the required parameter 'ipId' is set
      if (ipId === undefined || ipId === null) {
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:sendpost/model/IP}
     */
    updateIp(iPUpdateRequest, ipId) {
      return this.updateIpWithHttpInfo(iPUpdateRequest, ipId)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
