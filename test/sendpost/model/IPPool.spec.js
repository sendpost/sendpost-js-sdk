...
(function(root, factory) {
  ...
  describe('IPPool', function() {
    it('should create an instance of IPPool', function() {
      ...
      //var instance = new sendpost.IPPool();
      //expect(instance).to.be.a(sendpost.IPPool);
    });
    ...
    it('should have the property shouldOverflow (base name: "shouldOverflow")', function() {
      // uncomment below and update the code to test the property shouldOverflow
      //var instance = new sendpost.IPPool();
      //expect(instance).to.be();
    });

    it('should have the property overflowPoolName (base name: "overflowPoolName")', function() {
      // uncomment below and update the code to test the property overflowPoolName
      //var instance = new sendpost.IPPool();
      //expect(instance).to.be();
    });
