...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new sendpost.AggregatedEmailStats();
  });
  ...
  describe('AggregatedEmailStats', function() {
    it('should create an instance of AggregatedEmailStats', function() {
      // uncomment below and update the code to test AggregatedEmailStats
      //var instance = new sendpost.AggregatedEmailStats();
      //expect(instance).to.be.a(sendpost.AggregatedEmailStats);
    });
