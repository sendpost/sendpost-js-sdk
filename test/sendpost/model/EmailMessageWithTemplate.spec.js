...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new sendpost.EmailMessageWithTemplate();
  });
  ...
  describe('EmailMessageWithTemplate', function() {
    it('should create an instance of EmailMessageWithTemplate', function() {
      // uncomment below and update the code to test EmailMessageWithTemplate
      //var instance = new sendpost.EmailMessageWithTemplate();
      //expect(instance).to.be.a(sendpost.EmailMessageWithTemplate);
    });
    ...
    it('should have the property webhookEndpoint (base name: "webhookEndpoint")', function() {
      // uncomment below and update the code to test the property webhookEndpoint
      //var instance = new sendpost.EmailMessageWithTemplate();
      //expect(instance).to.be();
    });
