...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new sendpost.StatStats();
  });
  ...
  describe('StatStats', function() {
    it('should create an instance of StatStats', function() {
      // uncomment below and update the code to test StatStats
      //var instance = new sendpost.StatStats();
      //expect(instance).to.be.a(sendpost.StatStats);
    });
