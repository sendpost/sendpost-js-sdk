...
(function(root, factory) {
  ...
  describe('IP', function() {
    it('should create an instance of IP', function() {
      ...
      //var instance = new sendpost.IP();
      //expect(instance).to.be.a(sendpost.IP);
    });
    ...
    it('should have the property autoWarmupPlan (base name: "autoWarmupPlan")', function() {
      // uncomment below and update the code to test the property autoWarmupPlan
      //var instance = new sendpost.IP();
      //expect(instance).to.be();
    });
