...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new sendpost.EmailStatsStats();
  });
  ...
  describe('EmailStatsStats', function() {
    it('should create an instance of EmailStatsStats', function() {
      // uncomment below and update the code to test EmailStatsStats
      //var instance = new sendpost.EmailStatsStats();
      //expect(instance).to.be.a(sendpost.EmailStatsStats);
    });
