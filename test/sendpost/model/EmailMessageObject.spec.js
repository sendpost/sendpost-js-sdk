...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new sendpost.EmailMessageObject();
  });
  ...
  describe('EmailMessageObject', function() {
    it('should create an instance of EmailMessageObject', function() {
      // uncomment below and update the code to test EmailMessageObject
      //var instance = new sendpost.EmailMessageObject();
      //expect(instance).to.be.a(sendpost.EmailMessageObject);
    });
