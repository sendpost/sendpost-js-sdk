...
(function(root, factory) {
  ...
  describe('Message', function() {
    it('should create an instance of Message', function() {
      ...
      //var instance = new sendpost.Message();
      //expect(instance).to.be.a(sendpost.Message);
    });
    ...
    it('should have the property accountIPPoolID (base name: "accountIPPoolID")', function() {
      // uncomment below and update the code to test the property accountIPPoolID
      //var instance = new sendpost.Message();
      //expect(instance).to.be();
    });
