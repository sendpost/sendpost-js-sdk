...
(function(root, factory) {
  ...
  describe('Event', function() {
    it('should create an instance of Event', function() {
      ...
      //var instance = new sendpost.Event();
      //expect(instance).to.be.a(sendpost.Event);
    });
    ...
    it('should have the property ipPoolID (base name: "ipPoolID")', function() {
      // uncomment below and update the code to test the property ipPoolID
      //var instance = new sendpost.Event();
      //expect(instance).to.be();
    });
