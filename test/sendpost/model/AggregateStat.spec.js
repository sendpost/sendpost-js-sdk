...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new sendpost.AggregateStat();
  });
  ...
  describe('AggregateStat', function() {
    it('should create an instance of AggregateStat', function() {
      // uncomment below and update the code to test AggregateStat
      //var instance = new sendpost.AggregateStat();
      //expect(instance).to.be.a(sendpost.AggregateStat);
    });
