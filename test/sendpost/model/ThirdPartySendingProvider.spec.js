...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new sendpost.ThirdPartySendingProvider();
  });
  ...
  describe('ThirdPartySendingProvider', function() {
    it('should create an instance of ThirdPartySendingProvider', function() {
      // uncomment below and update the code to test ThirdPartySendingProvider
      //var instance = new sendpost.ThirdPartySendingProvider();
      //expect(instance).to.be.a(sendpost.ThirdPartySendingProvider);
    });
