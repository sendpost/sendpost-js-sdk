...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new sendpost.AccountStatsStat();
  });
  ...
  describe('AccountStatsStat', function() {
    it('should create an instance of AccountStatsStat', function() {
      // uncomment below and update the code to test AccountStatsStat
      //var instance = new sendpost.AccountStatsStat();
      //expect(instance).to.be.a(sendpost.AccountStatsStat);
    });
    ...
    it('should have the property spams (base name: "spams")', function() {
      // uncomment below and update the code to test the property spams
      //var instance = new sendpost.AccountStatsStat();
      //expect(instance).to.be();
    });
