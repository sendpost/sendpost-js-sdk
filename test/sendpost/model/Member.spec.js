...
(function(root, factory) {
  ...
  describe('Member', function() {
    it('should create an instance of Member', function() {
      ...
      //var instance = new sendpost.Member();
      //expect(instance).to.be.a(sendpost.Member);
    });
    ...
    it('should have the property notesColor (base name: "notesColor")', function() {
      // uncomment below and update the code to test the property notesColor
      //var instance = new sendpost.Member();
      //expect(instance).to.be();
    });
