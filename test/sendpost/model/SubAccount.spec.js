...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new sendpost.SubAccount();
  });
  ...
  describe('SubAccount', function() {
    it('should create an instance of SubAccount', function() {
      ...
      //var instance = new sendpost.SubAccount();
      //expect(instance).to.be.a(sendpost.SubAccount);
    });
    ...
    it('should have the property isPlus (base name: "isPlus")', function() {
      // uncomment below and update the code to test the property isPlus
      //var instance = new sendpost.SubAccount();
      //expect(instance).to.be();
    });
    ...
    it('should have the property blockedAt (base name: "blocked_at")', function() {
      // uncomment below and update the code to test the property blockedAt
      //var instance = new sendpost.SubAccount();
      //expect(instance).to.be();
    });

    it('should have the property blockReason (base name: "block_reason")', function() {
      // uncomment below and update the code to test the property blockReason
      //var instance = new sendpost.SubAccount();
      //expect(instance).to.be();
    });

    it('should have the property hbExempt (base name: "hb_exempt")', function() {
      // uncomment below and update the code to test the property hbExempt
      //var instance = new sendpost.SubAccount();
      //expect(instance).to.be();
    });

    it('should have the property generateWeeklyReport (base name: "generate_weekly_report")', function() {
      // uncomment below and update the code to test the property generateWeeklyReport
      //var instance = new sendpost.SubAccount();
      //expect(instance).to.be();
    });

    it('should have the property handlers (base name: "handlers")', function() {
      // uncomment below and update the code to test the property handlers
      //var instance = new sendpost.SubAccount();
      //expect(instance).to.be();
    });
