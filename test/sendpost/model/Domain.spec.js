...
(function(root, factory) {
  ...
  describe('Domain', function() {
    it('should create an instance of Domain', function() {
      ...
      //var instance = new sendpost.Domain();
      //expect(instance).to.be.a(sendpost.Domain);
    });
    ...
    it('should have the property domainRegisteredDate (base name: "domainRegisteredDate")', function() {
      // uncomment below and update the code to test the property domainRegisteredDate
      //var instance = new sendpost.Domain();
      //expect(instance).to.be();
    });
    ...
    it('should have the property gptVerified (base name: "gptVerified")', function() {
      // uncomment below and update the code to test the property gptVerified
      //var instance = new sendpost.Domain();
      //expect(instance).to.be();
    });

    it('should have the property gpt (base name: "gpt")', function() {
      // uncomment below and update the code to test the property gpt
      //var instance = new sendpost.Domain();
      //expect(instance).to.be();
    });

    it('should have the property dmarcFailureReason (base name: "dmarcFailureReason")', function() {
      // uncomment below and update the code to test the property dmarcFailureReason
      //var instance = new sendpost.Domain();
      //expect(instance).to.be();
    });

    it('should have the property dkimFailureReason (base name: "dkimFailureReason")', function() {
      // uncomment below and update the code to test the property dkimFailureReason
      //var instance = new sendpost.Domain();
      //expect(instance).to.be();
    });

    it('should have the property trackFailureReason (base name: "trackFailureReason")', function() {
      // uncomment below and update the code to test the property trackFailureReason
      //var instance = new sendpost.Domain();
      //expect(instance).to.be();
    });

    it('should have the property returnPathFailureReason (base name: "returnPathFailureReason")', function() {
      // uncomment below and update the code to test the property returnPathFailureReason
      //var instance = new sendpost.Domain();
      //expect(instance).to.be();
    });
