...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new sendpost.EventMetadata();
  });
  ...
  describe('EventMetadata', function() {
    it('should create an instance of EventMetadata', function() {
      ...
      //var instance = new sendpost.EventMetadata();
      //expect(instance).to.be.a(sendpost.EventMetadata);
    });
    ...
    it('should have the property trackedIP (base name: "trackedIP")', function() {
      // uncomment below and update the code to test the property trackedIP
      //var instance = new sendpost.EventMetadata();
      //expect(instance).to.be();
    });

    it('should have the property rawUserAgent (base name: "rawUserAgent")', function() {
      // uncomment below and update the code to test the property rawUserAgent
      //var instance = new sendpost.EventMetadata();
      //expect(instance).to.be();
    });
