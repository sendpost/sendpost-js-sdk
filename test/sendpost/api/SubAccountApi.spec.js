...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new sendpost.SubAccountApi();
  });
  ...
  describe('SubAccountApi', function() {
    ...
    describe('deleteSubAccount', function() {
      it('should call deleteSubAccount successfully', function(done) {
        //uncomment below and update the code to test deleteSubAccount
        //instance.deleteSubAccount(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getAllSubAccounts', function() {
      it('should call getAllSubAccounts successfully', function(done) {
        //uncomment below and update the code to test getAllSubAccounts
        //instance.getAllSubAccounts(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('updateSubAccount', function() {
      it('should call updateSubAccount successfully', function(done) {
        //uncomment below and update the code to test updateSubAccount
        //instance.updateSubAccount(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
