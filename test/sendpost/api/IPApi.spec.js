...
(function(root, factory) {
  ...
  describe('IPApi', function() {
    describe('allocateNewIp', function() {
      it('should call allocateNewIp successfully', function(done) {
        //uncomment below and update the code to test allocateNewIp
        //instance.allocateNewIp(function(error) {
    ...
    describe('getAllIps', function() {
      it('should call getAllIps successfully', function(done) {
        //uncomment below and update the code to test getAllIps
        //instance.getAllIps(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getSpecificIp', function() {
      it('should call getSpecificIp successfully', function(done) {
        //uncomment below and update the code to test getSpecificIp
        //instance.getSpecificIp(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
