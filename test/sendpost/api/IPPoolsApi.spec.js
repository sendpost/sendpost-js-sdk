...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new sendpost.IPPoolsApi();
  });
  ...
  describe('IPPoolsApi', function() {
    describe('createIPPool', function() {
      it('should call createIPPool successfully', function(done) {
        //uncomment below and update the code to test createIPPool
        //instance.createIPPool(function(error) {
    ...
    describe('deleteIPPool', function() {
      it('should call deleteIPPool successfully', function(done) {
        //uncomment below and update the code to test deleteIPPool
        //instance.deleteIPPool(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getAllIPPools', function() {
      it('should call getAllIPPools successfully', function(done) {
        //uncomment below and update the code to test getAllIPPools
        //instance.getAllIPPools(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getIPPoolById', function() {
      it('should call getIPPoolById successfully', function(done) {
        //uncomment below and update the code to test getIPPoolById
        //instance.getIPPoolById(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('updateIPPool', function() {
      it('should call updateIPPool successfully', function(done) {
        //uncomment below and update the code to test updateIPPool
        //instance.updateIPPool(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
